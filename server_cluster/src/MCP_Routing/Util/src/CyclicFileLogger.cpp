		...
		currentFileIndex_(0)
{
	...
	{
		throw spdr::IllegalArgumentException("number of files must be: 1 <= n <=100");
	}
	...
	else
	{
		if (maxFileSizeKB < 4)
		{
			throw spdr::IllegalArgumentException("maximal file size must be >=4kB");
		}
...
void CyclicFileLogger::print(spdr::log::Level log_level, const char *id, const char *message)
{
