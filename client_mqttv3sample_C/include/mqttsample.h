...
typedef struct {
    ...
    unsigned long long startTime;       /* time first message published or received */
...
extern unsigned int g_msg_number;   /* the number of messages to publish or subscribe */
extern unsigned int g_publish_count;/* the number of successful publishes*/   
extern unsigned int g_subscribe_count;/* the number of successful subscribes*/ 
extern unsigned int g_warning_count;
