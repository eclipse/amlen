...
public class ShellAction extends ApiCallAction {
    ...
    private void runCommand(String command, Boolean printResult) throws IsmTestException {
        try {
            ...
            try {
                ...
                throw new IsmTestException(e.getMessage(), e.getMessage());
            }
            ...
            if (_expected_rc.equals("-")) {
            	if (_expected_rc.intValue() == 0) {
            		...
            		throw new IsmTestException("UnexpectedRC", "UnexpectedRC");
            	} else {
            		return;
            	}
