...
# that you have already called the corresponding start script. (imaAutoSVT_start_automation.sh)
#
# Input Parameters:
...
RUNCMD="../scripts/run-scenarios.sh  ima-SVT_IMA_ENV-stop_automation.sh ${logfile}"
