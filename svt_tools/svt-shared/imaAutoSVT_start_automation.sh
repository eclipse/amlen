...
#
# Description:
# This should only be run by the Automation environment. By running this script you agree to the contract
# that you will also eventually call the corresponding stop script. (imaAutoSVT_stop_automation.sh)
#
# Input Parameters:
...
RUNCMD="../scripts/run-scenarios.sh  ima-SVT_IMA_ENV-start_automation.sh ${logfile}"
