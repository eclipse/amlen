...
#  shell_source('/niagara/test/scripts/ISMsetup.sh')
   ...
   url = 'http://{0}/ima/v1/monitor/Subscription'.format(SERVER)
   ...
   for item in data['Subscription']:
      url = 'http://{0}/ima/v1/configuration/Subscription/{1}?SubscriptionName={2}'.format(SERVER, item['ClientID'], item['SubName'])
      print url
