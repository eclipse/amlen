...
#----------------------------------------------------------------------------------------
#  show_version
# Set VERSION_TYPE so you konw how to get to busybox/enableshell
#----------------------------------------------------------------------------------------
...
if [[ $# -lt 2 ]] || [[ $# -gt 5 ]]; then
   ...
   echo " BUILD_1    (optional)  First FULL BUILD URL installed first"
   echo " BUILD_2    (optional)  Second FULL BUILD URL installed via first firmware upgrade, script toggle betweent the two"
   echo ""
   echo "Assumptions:"
...
declare BUILD_2="http://10.10.10.10/release/IMA110/production/20140507-1143/appliance/rel_bedrock.scrypt2"
