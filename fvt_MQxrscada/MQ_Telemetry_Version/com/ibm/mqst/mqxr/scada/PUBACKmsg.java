 ...
 * @version 1.0
 */
/* This class represents SDP message type PUBACK */

public class PUBACKmsg extends MsgTemplate
{

    byte[] msgIdentifier;

    // Parse constructor from superclass (see MsgTemplate.java)
    public PUBACKmsg(DataInputStream in) throws IOException
    {
        super(in);
    }

    public PUBACKmsg(DataInputStream in, boolean readHeader) throws IOException
    {
        super(in, readHeader ? MsgTemplate.getFixedHeader(in) : Headers.PUBACK);
    }

    // Basic constructor - takes msgId - rest of data is constant
    public PUBACKmsg(MsgIdentifier id)
    {

        fixedHeader = SCADAutils.setBits(0, 1, 0, 0, 0, 0, 0, 0);
    ...
    // Runs through and prints out mesage byte information
