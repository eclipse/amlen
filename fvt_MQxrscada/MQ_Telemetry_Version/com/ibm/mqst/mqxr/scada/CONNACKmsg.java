...
public class CONNACKmsg extends MsgTemplate
{
    ...
    public CONNACKmsg(DataInputStream in, boolean readHeader) throws IOException
    {
        super(in, readHeader ? MsgTemplate.getFixedHeader(in) : Headers.CONNACK);
    }
    ...
    public void parseAndPrint(LogFile log) throws IOException
    {
        ...
        int offset = 2;
        SCADAutils.printByteNumeric(completeMsg[offset], log, "UNUSED", offset);
        offset++;
