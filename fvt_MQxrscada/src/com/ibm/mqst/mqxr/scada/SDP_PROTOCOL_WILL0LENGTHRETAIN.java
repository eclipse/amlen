...
public class SDP_PROTOCOL_WILL0LENGTHRETAIN
{
    ...
    public static void main(String[] args)
    {
        ...
        // Testcase
        String testName = "SDP_PROTOCOL_WILL0LENGTHRETAIN";
        ...
        String retainMessage = "THIS IS THE REATIN MESSAGE";
        byte willQos = 0;
        ...
        try
        {
            ...
            connect1 = new CONNECTmsg(clientId1, willTopic, "", willQos);
            ...
            pubIn1EX = new PUBLISHmsg(willTopic, retainMessage.getBytes());
            pubIn1EX.setRetain();
            pubIn1EX.sendAndAcknowledge(input1, output1, pubLog, resultsLog);
            ...
            //Should only receive a SUBACK, not a RETAINed message.
            ...
            try {
            	MsgTemplate msg = SCADAutils.getGenericMsg(input2);
            	msg.parseAndPrint(pubLog);
            	if (msg instanceof SUBACKmsg) {
            		msg = SCADAutils.getGenericMsg(input2);
                	msg.parseAndPrint(pubLog);
            	}
                resultsLog.println("Expected to not receive message");
                testPassed = false;
            } catch (IOException e) {
