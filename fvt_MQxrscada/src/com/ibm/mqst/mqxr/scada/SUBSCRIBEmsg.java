...
{
	public static final int MYTYPE = 8;
    ...
    public SUBSCRIBEmsg(DataInputStream in, byte header) throws IOException
    {
    ...
    private void buildMsg() throws ScadaException
    {
        ...
        if (SCADAutils.version >= 5)
            construct.addElement(new Byte((byte)0));        /* props */
    ...
    public void sendAndAcknowledge(DataInputStream input, DataOutputStream output, SUBACKmsg subAckEX, LogFile subLog, LogFile resultsLog) throws IOException, ScadaException
    {
        ...
        // compare received and expected SUBACK, ignoring QoS bytes
        SCADAutils.compareAndLog(subAck, subAckEX, subLog, resultsLog, false);
