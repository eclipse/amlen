...
{
	public static final int MYTYPE = 9;
    ...
    public SUBACKmsg(DataInputStream in, byte header) throws IOException
    {
    ...
    public SUBACKmsg(SubList topics, MsgIdentifier id) throws ScadaException
    {
    	...
    	fixedHeader = SCADAutils.setBits(1, 0, 0, 1, 0, 0, 0
    			, 0); // Note that
                                                                    // Qos1 is
                                                                    // specified
                                                                    // - even
    ...
    public void rebuild() throws ScadaException {
    	buildMsg();
    }
