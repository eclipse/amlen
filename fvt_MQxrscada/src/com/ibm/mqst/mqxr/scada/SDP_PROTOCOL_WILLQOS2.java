...
public class SDP_PROTOCOL_WILLQOS2
{
    ...
    public static void main(String[] args)
    {
        ...
        // Testcase
        String testName = "SDP_PROTOCOL_WILLQOS2";
        ...
        SubList subList;
        MsgIdentifier subId;
        MsgIdentifier pub1Id; // Qos 2

        // Test data
        String clientId1 = "C1WillQoS2";
        String clientId2 = "C2WillQoS2";
         
        String willTopic = "WillQos2";
