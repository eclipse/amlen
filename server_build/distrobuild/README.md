...
5) Build the code and produce the rpm:
    ```
    mock -r fedora-34-x86_64 ~/rpmbuild/SRPMS/AmlenServer-1.0.0.2-1.fc34.src.rpm
    ```
...
```
mock -r epel-8_javapkg-x86_64 ~/rpmbuild/SRPMS/AmlenServer-1.0.0.2-1.fc34.src.rpm 
```
...
mock -r fedora-34-x86_64 -n  ~/rpmbuild/SRPMS/AmlenWebUI-1.0.0.2-1.fc34.src.rpm 
``` 
...
4. `mock -r fedora-34-x86_64 ~/rpmbuild/SRPMS/AmlenMQCBridge-1.0.0.2-1.fc34.src.rpm`
...
3) Build the rpm:
```
mock -r fedora-34-x86_64 ~/rpmbuild/SRPMS/AmlenBridge-1.0.0.2-1.fc34.src.rpm
```
...
mock -r fedora-34-x86_64 ~/rpmbuild/SRPMS/AmlenProtocolPlugin-1.0.0.2-1.fc34.src.rpm
```
...
mock -r fedora-34-x86_64 ~/rpmbuild/SRPMS/AmlenSDK-1.0.0.2-1.fc34.src.rpm
```
