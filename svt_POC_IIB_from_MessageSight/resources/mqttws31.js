 ...
 * connect to an MQTT-supporting messaging server, for example WebsShere MQ v7.5.0.1 with the MQ Telemetry 
 * feature installed. 
 *  
    ...
    ClientImpl.prototype._on_socket_message = function (event) {
        ...
        switch(wireMessage.type) {
            case MESSAGE_TYPE.CONNACK:
        	    ...
        	    // Sort sentMessages into the orinal sent order.
            ...
            case MESSAGE_TYPE.DISCONNECT:
            	// Clients to not expect to receive disconnect.
