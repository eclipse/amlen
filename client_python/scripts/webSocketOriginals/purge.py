...
# MessageSight command line interface to clear a Log
...
def main(argv):
    ...
    # Parse arguments
    parser = argparse.ArgumentParser(description='Clear a Log File' )
    parser.add_argument('-s', metavar='adminServerIP:port', required=True, type=str, help='adminServerIP:port')
    parser.add_argument('object', metavar='ConfigObject', type=str, help='Configuration object', choices=['admin.log', 'connection.log', 'default.log', 'mqconnectivity.log', 'security.log'] )
    ...
    rc = parseResponse( 'Purge', adminServer, objectType, response )
