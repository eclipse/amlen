...
#    parser = argparse.ArgumentParser(description='Get configuration object', epilog=usage())
    parser = argparse.ArgumentParser(description='Get configuration object' )
...
#        payload_str = '{"Locale":"en_US","User":"admin","Action":"get","Item":"' + objectType + '","Component":"Server"'+ param_str +' }'
        payload_str = '{"Locale":"en_US","User":"admin","Action":"get","Item":"' + objectType + '"'+ param_str +' }'
    trace( 'CMD: \n'+ payload_str )
    ...
    rc = parseResponse( 'Get', adminServer, objectType, response )
