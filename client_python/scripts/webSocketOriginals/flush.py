...
# MessageSight command line interface to Force write of all pending lines in Trace Log
...
def main(argv):
    ...
    parser.add_argument('object', metavar='ConfigObject', type=str, help='Configuration object', choices=['Trace'] )
    ...
    # Set payload
    payload_str = '{"Locale":"en_US","User":"admin","Action":"' + objectType + '","DBGLOG":"" }'
    trace( 'CMD: \n'+ payload_str )
    ...
    rc = parseResponse( 'Flush', adminServer, objectType, response )
