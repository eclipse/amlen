...
def main(argv):
   ...
   while (INDEX < int(A_COUNT)):
      ...
      CLUSTERNAME = '{0}_CLUSTER'.format(MQKEY)
      failures = verifystatus(failures,HOST1,PORT1,"Running (production)",False,"","",True,CLUSTERNAME,"Active",int(A_COUNT)-1)
      failures = verifystatus(failures,HOST2,PORT2,"Running (production)",False,"","",True,CLUSTERNAME,"Active",int(A_COUNT)-1)
      INDEX += 2
