...
CURDIR=`pwd`
export CURDIR
DATADIR=/var/imabridge
export DATADIR
DIAGDIR=/var/imabridge/diag
export DIAGDIR
LOGDIR=/var/imabridge/diag/logs
export LOGDIR
COREDIR=/var/imabridge/diag/cores
export COREDIR
...
# Set default values
IMACFGDIR=${DATADIR}
IMASERVERCFG=/opt/ibm/imabridge/bin/imabridge.cfg
IMADYNSERVERCFG=/var/imabridge/bridge.cfg
