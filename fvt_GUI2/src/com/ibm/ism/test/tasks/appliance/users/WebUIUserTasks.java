...
public class WebUIUserTasks {
	...
	public static void loadServerURL(IsmTestData testData) throws Exception {
		CoreLogger.testStart("Go to Server Connections page");
		//WebBrowser.loadURL(testData.getURL() + "/index.jsp?server=127.0.0.1:9089");
		WebBrowser.loadURL(testData.getURL() + "/index.jsp?server=127.0.0.1%3A9089&serverName=MYLOCALHOST");
		Platform.sleep(3);
		//verifyPageLoaded();
	}
