...
//		String testDesc = "Create User";
		...
		WebBrowser.loadUrl(testData.getURL());
		     ...
		     //CoreLogger.testStart("My Test is Starting now");
//		CoreLogger.enableDebugLogging();
//		CoreLogger.info("Enable Debug");
		//CoreLogger.enableScreenshotsOnWarnings();
		//CoreLogger.error("ERROR1");
		//CoreLogger.debug("DEBUG");
		//CoreLogger.info("INFO");
		//CoreLogger.info(testData.getTestcaseAuthor());
		//CoreLogger.info(testData.getTestcaseDescription());
		//CoreLogger.info(testData.getTestArea());
...
//			CoreLogger.disableDebugLogging();
			result = true;
		} catch (Exception e){
