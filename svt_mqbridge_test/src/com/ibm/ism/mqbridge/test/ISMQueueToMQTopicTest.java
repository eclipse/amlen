...
public class ISMQueueToMQTopicTest extends MessagingTest implements MessageListener {
	public ISMQueueToMQTopicTest(String clientID) {
		super(clientID);
...
//	private static LoggingUtilities logger;
	static ISMQueueToMQTopicTest test;
...
//	static MessageUtilities messageUtilities;
	...
	public static void main(String[] args) {
		try {
			test = new ISMQueueToMQTopicTest("ISM2MQ");
