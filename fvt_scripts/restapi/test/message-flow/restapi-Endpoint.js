...
var defaultTestEndpoint = {"Endpoint":{"TestEndpoint": { "ConnectionPolicies": "DemoConnectionPolicy", "Port": 1776, "MessageHub": "DemoHub", "TopicPolicies": "DemoTopicPolicy", "Description": "The NEW TEST Endpoint.", "Enabled": true, "Protocol": "JMS,MQTT", "SubscriptionPolicies": "TestSubscriptionPol", "Interface": "All", "InterfaceName": "All", "SecurityProfile": "", "QueuePolicies": null, "EnableAbout": false, "MaxMessageSize": "1024KB", "MaxSendSize": 16384, "BatchMessages": true}}}

var expectAllEndpoints = '{"Version": "' + FVT.version + '","Endpoint": { \
 ...
 "DemoMqttEndpoint": {  "Port": 1883,  "Enabled": false,  "Protocol": "MQTT",  "Interface": "All",  "InterfaceName": "All",  "ConnectionPolicies": "DemoConnectionPolicy",  "TopicPolicies": "DemoTopicPolicy",  "MaxMessageSize": "4096KB",  "MessageHub": "DemoHub",  "EnableAbout": true,  "Description": "Unsecured endpoint for demonstration use with MQTT protocol only. By default, it uses port 1883."  }, \
 "'+ FVT.long256Name +'": {  "Port": 1,  "ConnectionPolicies": "DemoConnectionPolicy",  "TopicPolicies": "DemoTopicPolicy",  "MessageHub": "DemoHub",  "Enabled": true,  "EnableAbout": false,  "Description": "'+ FVT.long1024String +'",  "QueuePolicies": null,  "Protocol": "JMS,MQTT",  "Interface": "All",  "InterfaceName": "All",  "SecurityProfile": "",  "SubscriptionPolicies": null,  "MaxMessageSize": "1024KB",  "MaxSendSize": 16384,  "BatchMessages": true  }, \
 "TestEndpoint": {  "Port": 1776,  "ConnectionPolicies": "DemoConnectionPolicy",  "TopicPolicies": "DemoTopicPolicy",  "MessageHub": "DemoHub",  "Enabled": true,  "EnableAbout": false,  "Description": "The NEW TEST Endpoint.",  "QueuePolicies": null,  "Protocol": "JMS,MQTT",  "Interface": "All",  "InterfaceName": "All",  "SecurityProfile": "",  "SubscriptionPolicies": "TestSubscriptionPol",  "MaxMessageSize": "1024KB",  "MaxSendSize": 16384,  "BatchMessages": true  }, \
 "TestSubscribeEndpoint": {  "Port": 1490,  "ConnectionPolicies": "DemoConnectionPolicy",  "TopicPolicies": "DemoTopicPolicy",  "MessageHub": "DemoHub",  "SubscriptionPolicies": "DemoSubscriptionPolicy",  "Enabled": true,  "EnableAbout": false,  "Description": "",  "QueuePolicies": null,  "Protocol": "JMS,MQTT",  "Interface": "All",  "InterfaceName": "All",  "SecurityProfile": "",  "MaxMessageSize": "1024KB",  "MaxSendSize": 16384,  "BatchMessages": true }}}' ;
...
// DemoMessagingPolicy is gone, eventually MsgingPolicy will go away and msg will change to 138
        it('should return status 400 on post "Max Length Name" Missing MsgingPolicies', function(done) {
...
//			verifyMessage = JSON.parse( '{"status":404,"Code": "CWLNA0138","Message": "The property name is invalid. Object: Endpoint Name: ' + FVT.long256Name + ' Property: MessagingPolicies"}' );
			verifyMessage = JSON.parse( '{"status":400,"Code": "CWLNA0138","Message": "The property name is invalid. Object: Endpoint Name: ' + FVT.long256Name + ' Property: MessagingPolicies"}' );
...
//		    verifyConfig = JSON.parse( '{"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: ' + FVT.long256Name + '","Endpoint":{"' + FVT.long256Name + '":{}}}' ) ;
		    verifyConfig = JSON.parse( '{"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: ' + FVT.long256Name + '","Endpoint":{"' + FVT.long256Name + '":{}}}' ) ;
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject+'/'+FVT.long256Name, FVT.verify404NotFound, verifyConfig, done);
        });

        it('should return status 200 on post "Max Length Name" with Topic Policy', function(done) {
...
// 100242 116106 (IPv6 is not working well)  IPv6 is only in Brackets when in URL HOST
...
//        });
        ...
        it('should return status 200 on POST "Interface":ipv4', function(done) {
            var payload = '{"Endpoint":{"TestEndpoint":{"Interface":"'+ FVT.A1_IPv4_INTERNAL_1 +'"}}}';
            verifyConfig = JSON.parse(payload);
            FVT.makePostRequest( FVT.uriConfigDomain, payload, FVT.postSuccessCallback, verifyConfig, done);
        });
...
/*  PROBLEMS getting from ENV - not part of TESTENV.SH , programatically could be done, need to investigate again
        ...
        it('should return status 200 on POST "InterfaceName":"ip2"', function(done) {
            var payload = '{"Endpoint":{"TestEndpoint":{"Interface":"'+ FVT.A1_msgServer_2 +'"}}}';
...
// MessagingPolicy has gone away
        it('should return status 400 on post "TestMsgPol"', function(done) {
            ...
            verifyConfig = JSON.parse(payload);
			verifyMessage = {"status":400,"Code":"CWLNA0140","Message":"The object MessagingPolicy is not valid."} ;
            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
        });
        it('should return status 404 on get, "TestMsgPol"', function(done) {
		    verifyConfig = {"status":404,"Code":"CWLNA0111","Message":"The property name is not valid: Property: MessagingPolicy.","MessagingPolicy":{"TestMsgPol":{}} };
...
//            FVT.verifyServerRestart( FVT.uriServiceDomain+'status', FVT.getSuccessCallback, verifyStatus, done)
        ...
        it('should return status 200 on get, "Endpoints" persists', function(done) {
            verifyConfig = JSON.parse( expectAllEndpoints ) ;
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject, FVT.getSuccessCallback, verifyConfig, done)
        });
...
//            verifyConfig = {"status":404,"Endpoint":{"MissingEndpoint":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MissingEndpoint","Endpoint":{"MissingEndpoint":{}}};
...
// 100253
        it('should return status 400 when DUPLICATE Port set  on Enabled:T Endpoint', function(done) {
            var payload = '{"Endpoint":{"PortIn̬Use-EnabledTrue":{"Port":1776,"ConnectionPolicies": "DemoConnectionPolicy","MessageHub": "DemoHub","TopicPolicies": "DemoTopicPolicy"}}}';
            verifyConfig = JSON.parse( payload );
//            verifyMessage = {"Code":"CWLNA0435","Message":"A port number is in use." };
...
//            verifyConfig = {"status":404,"Endpoint":{"PortInUse-EnabledTrue":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: PortInUse-EnabledTrue","Endpoint":{"PortInUse-EnabledTrue":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"PortRequired":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: PortRequired","Endpoint":{"PortRequired":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"BadPort":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: BadPort","Endpoint":{"BadPort":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"StringPort":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: StringPort","Endpoint":{"StringPort":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"NullPort":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: NullPort","Endpoint":{"NullPort":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"ConnectionPolicyRequired":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: ConnectionPolicyRequired","Endpoint":{"ConnectionPolicyRequired":{}}};
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject+'/'+'ConnectionPolicyRequired', FVT.verify404NotFound, verifyConfig, done);
        });

        it('should return status 400 when ConnectionPolicies misspelled ', function(done) {
...
//            verifyMessage = {"status":404,"Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: ConnectionPolicyMisspelled Property: ConnectionPolicy" };
            verifyMessage = {"status":400,"Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: ConnectionPolicyMisspelled Property: ConnectionPolicy" };
            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
        });
...
//            verifyConfig = {"status":404,"Endpoint":{"ConnectionPolicyMisspelled":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: ConnectionPolicyMisspelled","Endpoint":{"ConnectionPolicyMisspelled":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"ConnectionPolicyNotFound":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: ConnectionPolicyNotFound","Endpoint":{"ConnectionPolicyNotFound":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"MQTTTopicPolicyRequired":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MQTTTopicPolicyRequired","Endpoint":{"MQTTTopicPolicyRequired":{}}};
...
// 112475-112806  (Deemed too complicated to enforce) Sheila opened 138225 and R. said it was valid... uncommenting this block
...
//            verifyMessage = {"status":400,"Code":"CWLNA0357","Message":"If you specify a messaging policy where the destination type is Subscription, you must specify at least one messaging policy where the destination type is Topic. The topic messaging policy must grant publish authority to the topic that is associated with the subscription name specified in the subscription messaging policy. These messaging policies must be associated with the same endpoint: MQTTTopicPolicyRequired."  };
        ...
        it('should return status 404 on get, PublishOnlySubscribeEndpoint was not updated', function(done) {
            verifyConfig = {"status":404, "Code":"CWLNA0136", "Message":"The item or object cannot be found. Type: Endpoint Name: PublishOnlySubscribeEndpoint", "Endpoint":{"PublishOnlySubscribeEndpoint":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"MessagingPolicyRequired":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MessagingPolicyRequired","Endpoint":{"MessagingPolicyRequired":{}}};
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject+'/'+'MessagingPolicyRequired', FVT.verify404NotFound, verifyConfig, done);
        });
        it('should return status 400 when MessagingPolicy misspelled ', function(done) {
...
//            verifyMessage = {"status":404,"Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: MessagingPolicyMispelled Property: MessagingPolicy" };
            verifyMessage = {"status":400,"Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: MessagingPolicyMispelled Property: MessagingPolicy" };
            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
        });
...
//            verifyConfig = {"status":404,"Endpoint":{"MessagingPolicyMispelled":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MessagingPolicyMispelled","Endpoint":{"MessagingPolicyMispelled":{}}};
...
// should eventually go away... 9/17
        it('should return status 400 when Messaging Policy not found ', function(done) {
...
//            verifyMessage = {"status":404,"Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: MessagingPolicyNotFound Property: MessagingPolicies" };
            verifyMessage = {"status":400,"Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: MessagingPolicyNotFound Property: MessagingPolicies" };
            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
        });
...
//            verifyConfig = {"status":404,"Endpoint":{"MessagingPolicyNotFound":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MessagingPolicyNotFound","Endpoint":{"MessagingPolicyNotFound":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"TopicPolicyNotFound":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: TopicPolicyNotFound","Endpoint":{"TopicPolicyNotFound":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"QueuePolicyNotFound":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: QueuePolicyNotFound","Endpoint":{"QueuePolicyNotFound":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"SubscriptionPolicyNotFound":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: SubscriptionPolicyNotFound","Endpoint":{"SubscriptionPolicyNotFound":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"OneMessageHubTooMany":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: OneMessageHubTooMany","Endpoint":{"OneMessageHubTooMany":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"MessageHubRequired":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MessageHubRequired","Endpoint":{"MessageHubRequired":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"MessageHubNotFound":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MessageHubNotFound","Endpoint":{"MessageHubNotFound":{}}};
...
//            verifyMessage = JSON.parse( '{"status":400,"Code":"CWLNA0133","Message":"The name of the configuration object is too long. Object: Endpoint Name: '+ FVT.long257Name +'."}' );
            verifyMessage = JSON.parse( '{"status":400,"Code":"CWLNA0133","Message":"The name of the configuration object is too long. Object: Endpoint Property: Name Value: '+ FVT.long257Name +'."}' );
            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
        });
...
//            verifyConfig = JSON.parse( '{"status":404,"Endpoint":{"' + FVT.long257Name + '":{}}}' ) ;
            verifyConfig = JSON.parse( '{"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: ' + FVT.long257Name + '","Endpoint":{"' + FVT.long257Name + '":{}}}' );
...
//            verifyMessage =  JSON.parse( '{"status":400,"Code":"CWLNA0112","Message":"The property value is not valid: Property: Description Value: \\\"'+ FVT.long1025String +'\\\"."}' );
			verifyMessage = JSON.parse( '{"status":400,"Code":"CWLNA0144","Message":"The value that is specified for the property on the configuration object is too long. Object: Endpoint Property: Description Value: '+ FVT.long1025String +'." }' );
            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
        });
...
//            verifyConfig = JSON.parse( '{"status":404,"Endpoint":{"TooLongDescEndpoint":{}}}' ) ;
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: TooLongDescEndpoint","Endpoint":{"TooLongDescEndpoint":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"BadProtocolScada":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: BadProtocolScada","Endpoint":{"BadProtocolScada":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"Protocol_jmsmqttall":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: Protocol_jmsmqttall","Endpoint":{"Protocol_jmsmqttall":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"Protocol_blank":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: Protocol_blank","Endpoint":{"Protocol_blank":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz1023":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz1023","Endpoint":{"MaxMsgSz1023":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz268435456":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz268435456","Endpoint":{"MaxMsgSz268435456":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz3K":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz3K","Endpoint":{"MaxMsgSz3K":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz4_K":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz4_K","Endpoint":{"MaxMsgSz4_K":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz262145KB":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz262145KB","Endpoint":{"MaxMsgSz262145KB":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz257MB":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz257MB","Endpoint":{"MaxMsgSz257MB":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz254M":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz254M","Endpoint":{"MaxMsgSz254M":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSz253_M":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSz253_M","Endpoint":{"MaxMsgSz253_M":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxMsgSzempty":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxMsgSzempty","Endpoint":{"MaxMsgSzempty":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxSendSz127":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxSendSz127","Endpoint":{"MaxSendSz127":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxSendSzempty":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxSendSzempty","Endpoint":{"MaxSendSzempty":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"MaxSendSz65537":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: MaxSendSz65537","Endpoint":{"MaxSendSz65537":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"BatchMessagesString":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: BatchMessagesString","Endpoint":{"BatchMessagesString":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"BatchMessagesNumber":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: BatchMessagesNumber","Endpoint":{"BatchMessagesNumber":{}}} ;
...
//            verifyConfig = {"status":404,"Endpoint":{"EnabledString":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: EnabledString","Endpoint":{"EnabledString":{}}} ;
        ...
        it('should return status 404 on get, EnabledNumber was not created', function(done) {
            ...
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: EnabledNumber","Endpoint":{"EnabledNumber":{}}} ;
...
//        it('should return status 400 on POST "Interface":"IPv6" with []', function(done) {
...
//            verifyConfig = JSON.parse( payload );
//            verifyMessage = {"Code":"CWLNA0158","Message":"The IP address is not valid." };
//            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
//        });
//        it('should return status 404 on get, InterfaceIPv6 no [] was created', function(done) {
//            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: InterfaceIPv6","Endpoint":{"InterfaceIPv6":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"InterfaceHostname":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: InterfaceHostname","Endpoint":{"InterfaceHostname":{}}} ;
...
//          verifyConfig = {"status":404,"Endpoint":{"InterfaceEmpty":{}}};
          verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: InterfaceEmpty","Endpoint":{"InterfaceEmpty":{}}} ;
          FVT.makeGetRequest( FVT.uriConfigDomain+uriObject+'/'+'InterfaceEmpty', FVT.verify404NotFound, verifyConfig, done);
      });
        it('should return status 404 on get, InterfaceEmpty/ even with trailing slash', function(done) {
//            verifyConfig = {"status":404,"Endpoint":{"InterfaceEmpty":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: InterfaceEmpty","Endpoint":{"InterfaceEmpty":{}}} ;
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject+'/'+'InterfaceEmpty/', FVT.verify404NotFound, verifyConfig, done);
        });
    ...
    describe('InterfaceName[""]:', function() {
// 107354 (no longer 404/403, it is just ignored)
        it('should return status 200 on POST "InterfaceName":eth0 (not setable)', function(done) {
            ...
            verifyConfig = {"Endpoint":{"InterfaceNameNoSet":{"InterfaceName":"All","Port":6969,"ConnectionPolicies": "DemoConnectionPolicy","MessageHub": "DemoHub","TopicPolicies": "DemoTopicPolicy"}}} ;
// 107354            verifyMessage = {"status":403,"Code":"CWLNA0111","Message":"The property name is not valid: Property: InterfaceName." };
            FVT.makePostRequest( FVT.uriConfigDomain, payload, FVT.postSuccessCallback, verifyConfig, done);
        });
        it('should return status 404 on get, InterfaceNameNoSet was not created', function(done) {
...
//        });
        it('should return status 200 on get all after delete, "InterfaceIPv6" gone', function(done) {
            verifyConfig = {"Endpoint":{"InterfaceIPv6":{}}} ;
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject, FVT.getVerifyDeleteCallback, verifyConfig, done);
        });
...
//            verifyConfig = JSON.parse( '{"status":404,"Endpoint":{"InterfaceIPv6":{}}}' );
            verifyConfig = JSON.parse( '{"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: InterfaceIPv6","Endpoint":{"InterfaceIPv6":{}}}' );
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject+'/'+"InterfaceIPv6", FVT.verify404NotFound, verifyConfig, done);
        });
...
//            verifyConfig = JSON.parse( '{"status":404,"Endpoint":{"InterfaceNameNoSet":{}}}' );
            verifyConfig = JSON.parse( '{"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: InterfaceNameNoSet","Endpoint":{"InterfaceNameNoSet":{}}}' );
...
// eventually have MsgingPolicy go away 9/17
        it('should return status 400 on post "TestEnpoint" to set Dependency Delete Test', function(done) {
            ...
            verifyConfig = defaultTestEndpoint;
//			verifyMessage = {"status":404, "Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: TestEndpoint Property: MessagingPolicies" };
			verifyMessage = {"status":400, "Code":"CWLNA0138","Message":"The property name is invalid. Object: Endpoint Name: TestEndpoint Property: MessagingPolicies" };
            FVT.makePostRequestWithVerify( FVT.uriConfigDomain, payload, FVT.postFailureCallback, verifyConfig, verifyMessage, done);
        });
        it('should return status 200 on get, "TestEnpoint" to set Dependency Delete Test', function(done) {
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject, FVT.getSuccessCallback, verifyConfig, done);
        });
// Messaging Policy no longer exists
        it('should return status 404 when deleting "TestMsgPol" in use by TestEndpoint', function(done) {
...
//            verifyMessage = {"status":400,"Code": "CWLNA0376","Message": "The Object: MessagingPolicies, Name: TestMsgPol is still being used by Object: Endpoint, Name: TestEndpoint"};
            verifyMessage = {"status":404,"Code": "CWLNA0111","Message": "The property name is not valid: Property: MessagingPolicy."};
        ...
        it('should return status 404 on get after failed delete, "TestMsgPol" in use', function(done) {
//            verifyConfig = {"MessagingPolicy":{"TestMsgPol":{}}}; 
        ...
        it('should return status 200 on REPOST "TestEnpoint" to set Dependency Delete Test', function(done) {
            var payload = '{"Endpoint":{"TestEndpoint":{"ConnectionPolicies": "TestConnPol","MessageHub": "TestMsgHub", "TopicPolicies":"TestTopicPol", "QueuePolicies":"TestQueuePol", "SubscriptionPolicies":"TestSubscriptionPol" }}}';
            verifyConfig = JSON.parse(payload);
            FVT.makePostRequest( FVT.uriConfigDomain, payload, FVT.postSuccessCallback, verifyConfig, done);
        });
...
//            verifyConfig = {"status":404,"Endpoint":{"TestEndpoint":{}}};
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: TestEndpoint","Endpoint":{"TestEndpoint":{}}};
...
//            verifyConfig = {"status":404,"Endpoint":{"TestSubscribeEndpoint":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: Endpoint Name: TestSubscribeEndpoint","Endpoint":{"TestSubscribeEndpoint":{}}};
            FVT.makeGetRequest( FVT.uriConfigDomain+uriObject+'/'+'TestSubscribeEndpoint', FVT.verify404NotFound, verifyConfig, done);
        });
// Messaging Policy gone
        it('should return status 404 when deleting "TestMsgPol"', function(done) {
            var objName = 'TestMsgPol' ;
            var payload = '{"MessagingPolicy":{"'+ objName +'":{}}}' ;
            verifyConfig = JSON.parse( payload ) ;
//            verifyMessage = {"Status":200,"Code": "CWLNA6011","Message": "The requested configuration change has completed successfully."};
        ...
        it('should return status 404 on get all after delete, "TestMsgPol" gone', function(done) {
            verifyConfig = {"status":404,"Code": "CWLNA0111","Message": "The property name is not valid: Property: MessagingPolicy."};
            FVT.makeGetRequest( FVT.uriConfigDomain+'MessagingPolicy/', FVT.verify404NotFound, verifyConfig, done);
        });
...
//            verifyConfig = {"status":404,"TopicPolicy":{"TestTopicPol":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: TopicPolicy Name: TestTopicPol","TopicPolicy":{"TestTopicPol":{}}}; 
...
//            verifyConfig = {"status":404,"TopicPolicy":{"PublishTopicPol":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: TopicPolicy Name: PublishTopicPol","TopicPolicy":{"PublishTopicPol":{}}}; 
...
//            verifyConfig = {"status":404,"TopicPolicy":{"MQTTTopicPol":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: TopicPolicy Name: MQTTTopicPol","TopicPolicy":{"MQTTTopicPol":{}}}; 
...
//            verifyConfig = {"status":404,"TopicPolicy":{"JMSTopicPol":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: TopicPolicy Name: JMSTopicPol","TopicPolicy":{"JMSTopicPol":{}}}; 
...
//            verifyConfig = {"status":404,"SubscriptionPolicy":{"TestSubscriptionPol":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: SubscriptionPolicy Name: TestSubscriptionPol","SubscriptionPolicy":{"TestSubscriptionPol":{}}}; 
            FVT.makeGetRequest( FVT.uriConfigDomain+'SubscriptionPolicy/'+'TestSubscriptionPol', FVT.verify404NotFound, verifyConfig, done);
        });

        it('should return status 200 when deleting "TestQueuePol"', function(done) {
            var objName = 'TestQueuePol' ;
            var payload = '{"QueuePolicy":{"'+ objName +'":{}}}' ;
            verifyConfig = JSON.parse( payload ) ;
            verifyMessage = {"Status":200,"Code": "CWLNA6011","Message": "The requested configuration change has completed successfully."};
            FVT.makeDeleteRequest( FVT.uriConfigDomain+'QueuePolicy/'+objName, FVT.deleteSuccessCallback, verifyConfig, verifyMessage, done);
        });
        it('should return status 200 on get all after delete, "TestQueuePol" gone', function(done) {
            FVT.makeGetRequest( FVT.uriConfigDomain+'QueuePolicy/', FVT.getVerifyDeleteCallback, verifyConfig, done);
        });
        it('should return status 404 on get after delete, "TestQueuePol" not found', function(done) {
//            verifyConfig = {"status":404,"QueuePolicy":{"TestQueuePol":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: QueuePolicy Name: TestQueuePol","QueuePolicy":{"TestQueuePol":{}}}; 
            FVT.makeGetRequest( FVT.uriConfigDomain+'QueuePolicy/'+'TestQueuePol', FVT.verify404NotFound, verifyConfig, done);
        });
...
//            verifyConfig = {"status":404,"ConnectionPolicy":{"TestConnPol":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: ConnectionPolicy Name: TestConnPol","ConnectionPolicy":{"TestConnPol":{}}}; 
        ...
        it('should return status 404 on get after delete, "TestMsgHub" not found', function(done) {
//            verifyConfig = {"status":404,"MessageHub":{"TestMsgHub":{}}}; 
            verifyConfig = {"status":404,"Code":"CWLNA0136","Message":"The item or object cannot be found. Type: MessageHub Name: TestMsgHub","MessageHub":{"TestMsgHub":{}}}; 
            FVT.makeGetRequest( FVT.uriConfigDomain+'MessageHub/'+'TestMsgHub', FVT.verify404NotFound, verifyConfig, done);
        });
