...
timeouts[${n}]=30
scenario[${n}]="${xml[${n}]} Sample - JMS TemporaryTopicTest 16384 100 using IPv6 Address"
component[1]=javaAppDriver,m1,-e_TemporaryTopicTest,-o_16384_100,-s-IMAServer=${A1_IPv6_1}-IMAPort=${IMAPort}
component[2]=searchLogsEnd,m1,TemporaryTopicTest_2.comparetest
components[${n}]="${component[1]} ${component[2]}"
((n+=1))
