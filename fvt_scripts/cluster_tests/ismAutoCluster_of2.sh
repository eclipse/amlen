...
#------------------------------------------------------------------------------
# Run topic tree tests.
#------------------------------------------------------------------------------

RUNCMD="../scripts/run-scenarios.sh  common_topic_tree/ism-CommonTopicTree_of2-00.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )
...
RUNCMD="../scripts/run-scenarios.sh  cluster_monitor/ism-ClusterMonitor_of2-00.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )

../mqtt_td_tests/mqttv5_shared_subs/updateAllowMqttProxyProtocol.sh on

#------------------------------------------------------------------------------
# Run sharedmix sub tests.
#------------------------------------------------------------------------------

RUNCMD="../scripts/run-scenarios.sh  common_topic_tree/ism-CommonTopicTree_of2-mqttv5shared.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )

../mqtt_td_tests/mqttv5_shared_subs/updateAllowMqttProxyProtocol.sh off
...
RUNCMD="../scripts/run-scenarios.sh  common_topic_tree_mqttv5/ism-CommonTopicTree_of2v5-00.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )
...
RUNCMD="../scripts/run-scenarios.sh  client_set/ism-DeleteClientSet-01.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )
