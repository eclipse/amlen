...
#----------------------------------------------------
# Scenario 0 - Setup Client Set for HA
#----------------------------------------------------
# A1_A2 = HAPair 1
# A3_A4 = HAPair 2
xml[${n}]="restapi-ClientSet_Setup"
timeouts[${n}]=120
scenario[${n}]="${xml[${n}]} - ClientSet Delete ALL: Couple HA Pairs"
...
#
component[10]=cAppDriverRConlyChk,m1,"-e|mocha","-o|../restapi/test/clientset/restapi-DeleteAllClientSet.js","-s|THIS_AdminEndpoint=${A1_IPv4_1}:${A1_PORT}|TestEnv=HA"
component[11]=cAppDriverRConlyChk,m1,"-e|mocha","-o|../restapi/test/clientset/restapi-DeleteAllClientSet.js","-s|THIS_AdminEndpoint=${A2_IPv4_1}:${A2_PORT}|TestEnv=HA"
component[12]=cAppDriverRConlyChk,m1,"-e|mocha","-o|../restapi/test/clientset/restapi-DeleteAllClientSet.js","-s|THIS_AdminEndpoint=${A3_IPv4_1}:${A3_PORT}|TestEnv=HA"
component[13]=cAppDriverRConlyChkWait,m1,"-e|mocha","-o|../restapi/test/clientset/restapi-DeleteAllClientSet.js","-s|THIS_AdminEndpoint=${A4_IPv4_1}:${A4_PORT}|TestEnv=HA"
# 
component[14]=cAppDriverWait,m1,"-e|../jms_td_tests/HA/updateAllowSingleNIC.sh"
#
component[15]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|HA1CS|-c|../restapi/test/restapi.cli|-a|1","-s|A1_SERVERNAME=${A1_SERVERNAME}"
component[16]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|HA2CS|-c|../restapi/test/restapi.cli|-a|2","-s|A2_SERVERNAME=${A2_SERVERNAME}"
component[17]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|HA3CS|-c|../restapi/test/restapi.cli|-a|3","-s|A3_SERVERNAME=${A3_SERVERNAME}"
component[18]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|HA4CS|-c|../restapi/test/restapi.cli|-a|4","-s|A4_SERVERNAME=${A4_SERVERNAME}"
# 
...
#----------------------------------------------------
# Scenario 1 - HA Client Set Org Move
#----------------------------------------------------
...
component[41]=cAppDriverRConlyChkWait,m1,"-e|mocha","-o|../restapi/test/clientset/restapi-Export_BasicClientSet.js","-s|IMA_AdminEndpoint=${A1_IPv4_1}:${A1_PORT}|TestEnv=HA|A1_HOSTNAME_OS=$A1_HOSTNAME_OS|A1_HOSTNAME_OS_SHORT=$A1_HOSTNAME_OS_SHORT|A1_SERVERNAME=$A1_SERVERNAME|A2_SERVERNAME=${A2_SERVERNAME}|A3_SERVERNAME=${A3_SERVERNAME}|A3_HOSTNAME_OS_SHORT=$A3_HOSTNAME_OS_SHORT|A4_SERVERNAME=${A4_SERVERNAME}|IMA_AUTOMATION=$IMA_AUTOMATION"
...
# Delete ClientSet (A1)
# Failover Servers, verify nothing new is in store, A3 has new info
####component[80]=wsDriver,m1,client_set/${xmlSync[${n}]}.xml,delete
component[80]=wsDriverWait,m1,client_set/${xmlSync[${n}]}.xml,delete
component[81]=cAppDriverRConlyChkWait,m1,"-e|mocha","-o|../restapi/test/clientset/restapi-DeleteImEx_BasicClientSet.js","-s|IMA_AdminEndpoint=${A1_IPv4_1}:${A1_PORT}|TestEnv=HA|A1_HOSTNAME_OS=$A1_HOSTNAME_OS|A1_HOSTNAME_OS_SHORT=$A1_HOSTNAME_OS_SHORT|A1_SERVERNAME=$A1_SERVERNAME|A2_SERVERNAME=${A2_SERVERNAME}|A2_HOSTNAME_OS_SHORT=$A2_HOSTNAME_OS_SHORT|A3_SERVERNAME=${A3_SERVERNAME}|A3_HOSTNAME_OS_SHORT=$A3_HOSTNAME_OS_SHORT|A4_SERVERNAME=${A4_SERVERNAME}|A4_HOSTNAME_OS_SHORT=$A4_HOSTNAME_OS_SHORT|IMA_AUTOMATION=$IMA_AUTOMATION"
component[82]=wsDriverWait,m1,client_set/${xmlSync[${n}]}.xml,complete
component[83]=cAppDriverRConlyChkWait,m1,"-e|mocha","-o|../restapi/test/clientset/restapi-RestartImEx_BasicClientSet.js","-s|IMA_AdminEndpoint=${A1_IPv4_1}:${A1_PORT}|TestEnv=HA|A1_SERVERNAME=${A1_SERVERNAME}|A1_HOSTNAME_OS_SHORT=$A1_HOSTNAME_OS_SHORT|A2_SERVERNAME=${A2_SERVERNAME}|A2_HOSTNAME_OS_SHORT=$A2_HOSTNAME_OS_SHORT|A3_SERVERNAME=${A3_SERVERNAME}|A3_HOSTNAME_OS_SHORT=$A3_HOSTNAME_OS_SHORT|A4_SERVERNAME=${A4_SERVERNAME}|A4_HOSTNAME_OS_SHORT=$A4_HOSTNAME_OS_SHORT"
...
#----------------------------------------------------
# Scenario 2 - Cleanup Client Set After (HA)
#----------------------------------------------------
# A1 = ClusterMember1
# A2 = ClusterMember2
xml[${n}]="restapi-ClientSet_CleanUp"
timeouts[${n}]=90
scenario[${n}]="${xml[${n}]} - ClientSet Delete ALL: DE-Couple HA Pairs"
component[1]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup|-c|../restapi/test/restapi.cli|-a|1"
component[2]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup|-c|../restapi/test/restapi.cli|-a|2"
component[3]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup|-c|../restapi/test/restapi.cli|-a|3"
component[4]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup|-c|../restapi/test/restapi.cli|-a|4"
