...
#----------------------------------------------------
# Scenario 0 - Setup Client Set for Basic
#----------------------------------------------------
# A1 = From Server
# A3 = To Server
...
# 
component[15]=cAppDriverWait,m1,"-e|../jms_td_tests/HA/updateAllowSingleNIC.sh"

components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} ${component[5]} ${component[6]} ${component[7]} ${component[8]} ${component[10]} ${component[11]} ${component[12]} ${component[13]} ${component[15]}  "
...
#----------------------------------------------------
# Scenario 2 - Cleanup Client Set after Basic
#----------------------------------------------------
# A1 = ClusterMember1
# A2 = ClusterMember2
