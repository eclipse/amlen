...
scenario_set_name="ISM JSON Plugin Teardown"
...
timeouts[${n}]=200
# Set up the components for the test in the order they should start
component[1]=cAppDriver,m1,"-e|./pluginFunctions.sh","-o|-a|delete|-f|deletePlugin.log|-n|json_msg"
