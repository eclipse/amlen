...
component[1]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|export|-c|export_import/policy_config.cli"
component[2]=cAppDriverWait,m1,"-e|export_import/copy_file.sh","-o|/tmp/userfiles/testExport|/var/messagesight/."
component[3]=cAppDriverWait,m1,"-e|../common/serverReset.sh"
component[4]=cAppDriverWait,m1,"-e|export_import/copy_file.sh","-o|/var/messagesight/testExport|/tmp/userfiles/."
