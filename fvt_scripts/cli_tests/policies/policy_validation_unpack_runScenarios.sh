...
scenario_set_name="POLICY_VALIDATION_UNPACK"
...
#----------------------------------------------------
# Scenario 1 - policy_validation_init_1
#----------------------------------------------------
...
xml[${n}]="policy_validation_unpack_1"
timeouts[${n}]=45
scenario[${n}]="${xml[${n}]} - policy validation unpack 1"
component[1]=runCommandNow,m1,./unpackPolicyTests.sh
component[2]=runCommandNow,m2,./unpackPolicyTests.sh
