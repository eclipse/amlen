...
# install_app_fail.py
#
# This script is used to test error scenarios in the Resource Adapter
# environment. Specifically, the kind of errors that would prevent an
# application from launching.
#
# e.g. Invalid Username/Password on activation specification.
#
# It requires a minimal test.config file, fail.config, which specifies the
# location of the testTools_JCAfail.ear application, as well as the 
# activation specification configuration, FailMDB.
#
#
...
if (len(sys.argv) < 2 or len(sys.argv) > 3):
    print 'Usage: install_app_fail.py fail.config action [debug]'
