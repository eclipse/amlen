...
component[1]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setupSM|-c|mqttv5_shared_subsv5/policy_sharedmixv5.cli"
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_csF_error01"
timeouts[${n}]=20
scenario[${n}]="${xml[${n}]} - Test basic Errors in or MQTTv5 shared subs using a durable subscriber. "
component[1]=wsDriver,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,ALL
components[${n}]="${component[1]}"
((n+=1))
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_csT_error01"
timeouts[${n}]=20
...
#----------------------------------------------------
# Test Case  - testmqtt_sharedMix_csT_error02
#----------------------------------------------------
# xml[${n}]="testmqtt_sharedMixv5_csT_error02"
# timeouts[${n}]=20
...
# # Test Case  - testmqtt_sharedMix_csT_error01
# #----------------------------------------------------
# xml[${n}]="testmqtt_sharedMixv5_error03"
# timeouts[${n}]=20
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_01"
timeouts[${n}]=30
scenario[${n}]="${xml[${n}]} - SharedMix - check different subs on different topics with same subname "
component[1]=wsDriverWait,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,Subscribes
components[${n}]="${component[1]} "
((n+=1))
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_02"
timeouts[${n}]=120
scenario[${n}]="${xml[${n}]} - Basic test of mixed-durability sharedsubs - subscribing and messaging. "
component[1]=wsDriverWait,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,Subscribes
component[2]=cAppDriverLogWait,m1,"-e|../scripts/sumReceived.py,-o|-l|testmqtt_sharedMixv5_02.xml-Subscribes-M1.log|-t|500|-c|CF1|CF2|-v|2"
components[${n}]="${component[1]} ${component[2]} "
((n+=1))
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_03"
timeouts[${n}]=220
scenario[${n}]="${xml[${n}]} - Clients reconnecting and receiving after server restart. "
component[1]=sync,m1
component[2]=wsDriver,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,Publisher
component[3]=wsDriverWait,m2,mqttv5_shared_subsv5/${xml[${n}]}.xml,Subscribes
component[4]=sleep,5
component[5]=cAppDriverLogWait,m2,"-e|../scripts/sumReceived.py,-o|-l|testmqtt_sharedMixv5_03.xml-Subscribes-M2.log|-t|2500|-c|CF1|CF2|-v|2|-ge|1"
...
component[3]=wsDriverWait,m2,mqttv5_shared_subsv5/${xml[${n}]}.xml,Subscribes
component[4]=sleep,5
component[5]=cAppDriverLogWait,m2,"-e|../scripts/sumReceived.py,-o|-l|testmqtt_sharedMixv5_04.xml-Subscribes-M2.log|-t|8000|-c|CF1|CF2|CF3|CF4|CF5|-v|2|-ge|1"
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} ${component[5]}"
((n+=1))
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_05"
timeouts[${n}]=220
scenario[${n}]="${xml[${n}]} - Redelivery of in-flight msg on client disconnect. "
component[1]=sync,m1
# component[2]=wsDriverWait,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,CleanSession
component[2]=wsDriver,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,Publisher
component[3]=wsDriverWait,m2,mqttv5_shared_subsv5/${xml[${n}]}.xml,Subscribes
component[4]=sleep,5
component[5]=cAppDriverLogWait,m2,"-e|../scripts/sumReceived.py,-o|-l|testmqtt_sharedMixv5_05.xml-Subscribes-M2.log|-t|2500|-c|CF1|CF2|-v|2|-ge|1"
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} ${component[5]}"
((n+=1))
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_06"
timeouts[${n}]=260
scenario[${n}]="${xml[${n}]} - Wildcard subscriptions for share subs. "
component[1]=wsDriverWait,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,Subscribes
component[2]=cAppDriverLogWait,m1,"-e|../scripts/sumReceived.py,-o|-l|testmqtt_sharedMixv5_06.xml-Subscribes-M1.log|-t|600|-c|CF1|CF2|-v|2"
component[3]=cAppDriverLogWait,m1,"-e|../scripts/sumReceived.py,-o|-l|testmqtt_sharedMixv5_06.xml-Subscribes-M1.log|-t|1200|-c|CF3|CF4|-v|2"
component[4]=cAppDriverLogWait,m1,"-e|../scripts/sumReceived.py,-o|-l|testmqtt_sharedMixv5_06.xml-Subscribes-M1.log|-t|600|-c|CF5|CF6|-v|2"
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_07ND"
timeouts[${n}]=260
scenario[${n}]="${xml[${n}]} - Busy share test with many subscribes-unsubscribes, nondurable. "
component[1]=sync,m1
component[2]=wsDriver,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,BusySubs
component[3]=wsDriver,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,Pubs
components[${n}]="${component[1]} ${component[2]} ${component[3]}"
((n+=1))
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_07D"
timeouts[${n}]=260
scenario[${n}]="${xml[${n}]} - Busy share test with many subscribes-unsubscribes, nondurable. "
component[1]=sync,m1
# component[2]=wsDriverWait,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,CleanSession
...
#----------------------------------------------------
xml[${n}]="testmqtt_sharedMixv5_09"
timeouts[${n}]=260
component[1]=wsDriver,m1,mqttv5_shared_subsv5/${xml[${n}]}.xml,Test
components[${n}]="${component[1]}"
((n+=1))
...
# component[1]=cAppDriverLog,m1,"-e|../scripts/run-cli.sh","-o|-s|cleanupSM|-c|mqttv5_shared_subsv5/policy_sharedmixv5.cli"
# components[${n}]="${component[1]}"
# ((n+=1))
