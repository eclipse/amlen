...
scenario_set_name="MQTTv5 tests CleanStart and Sessions"
...
timeouts[${n}]=60
scenario[${n}]="${xml[${n}]} - set policies for the mqttv5 cleanstart bucket"
...
#----------------------------------------------------
xml[${n}]="testmqttv5_cleanstart_01"
timeouts[${n}]=300
scenario[${n}]="${xml[${n}]} - mqttv5 connect cleanStart - ConnAck SessionPresent"
component[1]=sync,m1
component[2]=wsDriverWait,m1,mqttv5_cleanstart/${xml[${n}]}.xml,setupSessions
component[3]=wsDriver,m1,mqttv5_cleanstart/${xml[${n}]}.xml,testCleanStart
...
#----------------------------------------------------
xml[${n}]="testmqttv5_pubsub_02_nonDurable"
timeouts[${n}]=300
...
#----------------------------------------------------
xml[${n}]="testmqttv5_pubsub_03_durableSession"
timeouts[${n}]=300
scenario[${n}]="${xml[${n}]} - mqttv5 Pub Sub Receive "
...
#----------------------------------------------------
# Test Case 4 - ClientId Steal - nonDurableSession  ==>  Updgrade/Downgrade MQTT version 
#----------------------------------------------------
xml[${n}]="testmqttv4_clientSteal_04_nonDurable"
timeouts[${n}]=300
...
# Test Case 4 - ClientId Steal - nonDurableSession  ==>  Updgrade/Downgrade MQTT version 
#----------------------------------------------------
xml[${n}]="testmqttv4_clientSteal_05_Durable"
timeouts[${n}]=300
scenario[${n}]="${xml[${n}]} - PAHO mqttv4 Pub Sub Receive with ClientId Steal"
component[1]=sync,m1
component[2]=wsDriverWait,m1,../jms_td_tests/msgdelivery/mqtt_clearRetained.xml,ALL
...
#----------------------------------------------------
xml[${n}]="testWSmqttv5_clientSteal_04_nonDurable"
timeouts[${n}]=300
...
#----------------------------------------------------
xml[${n}]="testmqttv5_clientSteal_04_nonDurable"
timeouts[${n}]=300
...
#----------------------------------------------------
xml[${n}]="testmqttv5_clientSteal_05_durable"
timeouts[${n}]=300
...
# Test Case 5 - ClientId Steal - DurableSession
#----------------------------------------------------
xml[${n}]="testWSmqttv5_clientSteal_05_durable"
timeouts[${n}]=300
...
timeouts[${n}]=80
scenario[${n}]="${xml[${n}]} - Cleanup policies for v5 cleanstart bucket"
