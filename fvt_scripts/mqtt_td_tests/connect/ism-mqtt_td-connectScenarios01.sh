...
component[4]=killComponent,m1,2,1,testmqtt_connect08
...
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_9
component[4]=killComponent,m1,2,1,testmqtt_connect10
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} "
((n+=1))
...
component[2]=wsDriverNocheck,m1,connect/${xml[${n}]}.xml,publish,-o_-l_9
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_9
component[4]=killComponent,m1,2,1,testmqtt_connect12
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} "
((n+=1))
...
component[2]=wsDriverNocheck,m1,connect/${xml[${n}]}.xml,publish,-o_-l_9
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_9
component[4]=killComponent,m1,2,1,testmqtt_connect15
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} "
((n+=1))
...
component[4]=runCommand,m1,../common/serverKillRestart.sh,1,testmqtt_connect21
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]}"
((n+=1))
...
component[2]=wsDriver,m1,connect/${xml[${n}]}.xml,publish,-o_-l_7
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_7,"-s|BITFLAG=-Djava.util.logging.config.file=./jsr47tofile.properties"
component[4]=runCommand,m1,../common/serverKillRestart.sh,1,testmqtt_connect22
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]}"
((n+=1))
...
component[2]=wsDriver,m1,connect/${xml[${n}]}.xml,publish,-o_-l_7
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_7,"-s|BITFLAG=-Djava.util.logging.config.file=./jsr47tofile.properties"
component[4]=runCommand,m1,../common/serverKillRestart.sh,1,testmqtt_connect23
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]}"
((n+=1))
...
#----------------------------------------------------
# Test Case  - mqtt_connectAnonClt
#----------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="testmqtt_connectAnonClt"
scenario[${n}]="${xml[${n}]} - Test MQTT Connection Policy that allows only anonymous clients"
timeouts[${n}]=60
# Set up the components for the test in the order they should start
component[1]=wsDriver,m1,connect/${xml[${n}]}.xml,ALL
components[${n}]="${component[1]} "
