...
timeouts[${n}]=50
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_MESSAGES"
...
timeouts[${n}]=600
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_SUBSCRIBE"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_QOS0 using IPv6 Address"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_QOS01"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_WILLQOS0"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_WILLQOS1 using IPv6 Address"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_WILLQOS2"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_WILLQOS0RETAIN using IPv6 Address"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_WILLQOS1RETAIN"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_WILLQOS2RETAIN using IPv6 Address"
...
timeouts[${n}]=40
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_RETAIN"
...
timeouts[${n}]=150
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_KEEPALIVE using IPv6 Address"
...
timeouts[${n}]=60
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_NETWORK using IPv6 Address"
...
timeouts[${n}]=300
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_ERRORS"
...
timeouts[${n}]=180
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_QOS02 using IPv6 Address"
component[1]=cAppDriverLog,m1,"-e|../scripts/run-cli.sh","-o|-s|settrace5|-c|policy_config.cli"
...
timeouts[${n}]=300
scenario[${n}]="${xml[${n}]} - SDP_PROTOCOL_WILL0LENGTHRETAIN"
...
timeouts[${n}]=180
scenario[${n}]="${xml[${n}]} - Clear all retained messages"
