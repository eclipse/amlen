...
# When there are multiple addresses test.Env.sh does not always have the correct address that used to send messages to A1  
...
RUNCMD="../scripts/run-scenarios.sh  ism-JMS-Setup-00.sh ${logfile}"
