...
scenario_set_name="JMS Message Delivery - 00"
...
if [[ "${FULLRUN}" == "TRUE" ]] ; then
	...
	timeouts[${n}]=60
	scenario[${n}]="${xml[${n}]} -  IPv6: Suspend/Resume connections and discriminating between similiar Topic names and duplicate ClientIDs (Two host)"
	component[1]=sync,m1
	...
	timeouts[${n}]=30
	scenario[${n}]="${xml[${n}]} - Multiple Connections Message Delivery with trace logging and setting Priority - Test 2  (Two host)"
	component[1]=sync,m1
	...
	#----------------------------------------------------
	# Scenario 9 - jms_msgdlvr1_009
	#----------------------------------------------------
	xml[${n}]="jms_msgdelivery_009"
	timeouts[${n}]=120
	scenario[${n}]="${xml[${n}]} - Message Selection at higher send rate and volume. (Two host)"
	component[1]=sync,m1
	component[2]=jmsDriver,m2,msgdelivery/jms_msgdelivery_009.xml,rmdr
	component[3]=jmsDriver,m1,msgdelivery/jms_msgdelivery_009.xml,rmdt
	components[${n}]="${component[1]} ${component[2]} ${component[3]}"
	((n+=1))
	
	#----------------------------------------------------
	# Scenario 9 - jms_msgdlvr1_009_async
	#----------------------------------------------------
	xml[${n}]="jms_msgdelivery_009_async"
	timeouts[${n}]=120
	scenario[${n}]="${xml[${n}]} - Message Selection with Async Prod. (Two host)"
	component[1]=sync,m1
	component[2]=jmsDriver,m2,msgdelivery/jms_msgdelivery_009_async.xml,rmdr
	component[3]=jmsDriver,m1,msgdelivery/jms_msgdelivery_009_async.xml,rmdt
	components[${n}]="${component[1]} ${component[2]} ${component[3]}"
	((n+=1))
fi
...
#----------------------------------------------------
# Scenario 15 - jms_msgdlvr1_015
#----------------------------------------------------
xml[${n}]="jms_msgdelivery_015"
timeouts[${n}]=60
scenario[${n}]="${xml[${n}]} - IPv6: Complex Message Selection test. Four producers, seven consumers.  (Two host)"
component[1]=sync,m1
component[2]=jmsDriver,m2,msgdelivery/jms_msgdelivery_015.xml,rmdr
component[3]=jmsDriver,m1,msgdelivery/jms_msgdelivery_015.xml,rmdt
components[${n}]="${component[1]} ${component[2]} ${component[3]}"
((n+=1))

#----------------------------------------------------
# Scenario 16 - jms_msgdlvr1_016
# Sets an environment variable for the number of delivery threads, 
#----------------------------------------------------
xml[${n}]="jms_msgdelivery_016"
timeouts[${n}]=60
scenario[${n}]="${xml[${n}]} - Complex Message Selection with mixed latin and GVT Characters."
component[1]=sync,m1
component[2]=jmsDriver,m2,msgdelivery/jms_msgdelivery_016.xml,rmdr,,"-s|IMADeliveryThreads=5"
component[3]=jmsDriver,m1,msgdelivery/jms_msgdelivery_016.xml,rmdt,,"-s|IMADeliveryThreads=5"
component[4]=searchLogsEnd,m1,msgdelivery/jms_msgdelivery_016.comparetestM1
component[5]=searchLogsEnd,m2,msgdelivery/jms_msgdelivery_016.comparetestM2
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} ${component[5]}"
((n+=1))
...
timeouts[${n}]=60
scenario[${n}]="${xml[${n}]} - IPv6 Large Messages. Below and Above Policy limits."
...
#----------------------------------------------------
# Scenario 19 - jms_msgdlvr1_019
#----------------------------------------------------
xml[${n}]="jms_msgdelivery_019"
timeouts[${n}]=80
scenario[${n}]="${xml[${n}]} - Test for closing sessions while messages still being sent. (Two host)"
component[1]=sync,m1
component[2]=jmsDriver,m2,msgdelivery/jms_msgdelivery_019.xml,rmdr
component[3]=jmsDriver,m1,msgdelivery/jms_msgdelivery_019.xml,rmdt
components[${n}]="${component[1]} ${component[2]} ${component[3]}"
((n+=1))

#----------------------------------------------------
# Scenario 20 - jms_msgdlvr1_020_slowconsumer
#----------------------------------------------------
xml[${n}]="jms_msgdelivery_020_slowConsumer"
timeouts[${n}]=60
scenario[${n}]="${xml[${n}]} - IPv6 Two consumers(one fast, one slow), auto_ack. "
component[1]=sync,m1
component[2]=jmsDriver,m2,msgdelivery/jms_msgdelivery_020_slowConsumer.xml,rmdr
component[3]=jmsDriver,m1,msgdelivery/jms_msgdelivery_020_slowConsumer.xml,rmdt
components[${n}]="${component[1]} ${component[2]} ${component[3]}"
((n+=1))
...
# jms_msgdlvr1_023
#----------------------------------------------------
xml[${n}]="jms_msgdelivery_023"
timeouts[${n}]=200
scenario[${n}]="${xml[${n}]} - Test for hitting max messages limit of a topic with no (non durable) subscribers (M1)"
component[1]=jmsDriver,m1,msgdelivery/jms_msgdelivery_023.xml,ALL
components[${n}]="${component[1]}"
((n+=1))
...
if [[ "${FULLRUN}" == "TRUE" ]] ; then
	#----------------------------------------------------
	# Scenario 1 - jms_msgdelivery_sys
	#----------------------------------------------------
	...
	#----------------------------------------------------
	# Scenario 9 - jms_msgdlvr1_009_mix
	#----------------------------------------------------
	xml[${n}]="jms_msgdelivery_009_mix"
	timeouts[${n}]=160
	scenario[${n}]="${xml[${n}]} - Message Selection with Sync and Async Prod and Cons"
	component[1]=sync,m1
	component[2]=jmsDriver,m2,msgdelivery/jms_msgdelivery_009_mix.xml,rmdr
	component[3]=jmsDriver,m1,msgdelivery/jms_msgdelivery_009_mix.xml,rmdt
	components[${n}]="${component[1]} ${component[2]} ${component[3]}"
	((n+=1))
fi
