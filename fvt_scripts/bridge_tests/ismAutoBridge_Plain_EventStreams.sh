...
#
# Description:
#   This script executes ISM test bucket for:  IMA MQTT BRIDGE Plain Scenarios.
#
# start:  from ../$TESTROOT/bridge_tests/   run:  ismAutoBridge_Plain.sh <log_file>
#
# Input Parameters:
...
RUNCMD="../scripts/run-scenarios.sh  plain/ism-Bridge-Plain-EventStreams01.sh ${logfile}"
