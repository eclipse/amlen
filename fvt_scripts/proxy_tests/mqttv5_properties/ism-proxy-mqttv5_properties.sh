...
#xml[${n}]="proxy_mqttV5_connect_ReceiveMax"
#scenario[${n}]="${xml[${n}]} - Test MQTTv5 CONNECT Properties ReceiveMax"
#timeouts[${n}]=45
## Set up the components for the test in the order they should start
#component[1]=sync,m1
#component[2]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,deviceLowRM,-o_-l_9
#component[3]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,appDefaultRM,-o_-l_9
#component[4]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,APPHighRM,-o_-l_9
#component[5]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,gtwyHighRM,-o_-l_9
...
#-------------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_connect_KeepAlive"
...
#-------------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_connect_SEI"
scenario[${n}]="${xml[${n}]} - Test MQTTv5 CONNECT Properties Session Expiry Interval"
timeouts[${n}]=180
# Set up the components for the test in the order they should start
component[1]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,SEI_lessThanProxy,-o_-l_9
component[2]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,SEI_MAXedToProxy,-o_-l_9
component[3]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,SEI_greaterThanProxy,-o_-l_9
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_publish_PFI"
...
#-------------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_publish_MEI"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_pubPropError_PFI"
scenario[${n}]="${xml[${n}]} - Test MQTTv5 Publish Properties Payload Format Indicator"
timeouts[${n}]=180
# Set up the components for the test in the order they should start
component[1]=sync,m1
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_pubPropError_TA"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_pubPropError_SI"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_subscribe_UP"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_unsubscribe_UP"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_subOptions_NoLocal"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_subOptionsError_NoLocal"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_subOptions_RetainAsPub"
...
#----------------------------------------------------------
# Test Case  - MQTTv5 Subscribe Options RetainAsPublish Shared Subscription
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_subOptions_RetainAsPub_share"
scenario[${n}]="${xml[${n}]} - Test MQTTv5 Subscribe Options RetainAsPublish on Shared Subscription"
timeouts[${n}]=30
# Set up the components for the test in the order they should start
component[1]=sync,m1
component[2]=wsDriver,m1,mqttv5_properties/${xml[${n}]}.xml,pub,-o_-l_9
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_subOptions_RetainHandling"
...
#----------------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="proxy_mqttV5_subOptionsError_RetainHandling"
