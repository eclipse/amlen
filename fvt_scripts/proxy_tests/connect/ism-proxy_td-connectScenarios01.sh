...
scenario_directory="connect"
sceanrio_file="ism-proxy_td-connectScenarios01.sh"
...
#----------------------------------------------------
# The prefix of the XML configuration file for the driver
xml[${n}]="testproxy_connect03"
scenario[${n}]="${xml[${n}]} - Test MQTT/WebSocket connect valid user/password ${scenario_at}"
timeouts[${n}]=60
# Set up the components for the test in the order they should start
...
component[4]=killComponent,m1,2,1,testproxy_connect08
...
component[2]=wsDriverNocheck,m1,connect/${xml[${n}]}.xml,publish
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive
component[4]=killComponent,m1,2,1,testproxy_connect09
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} "
...
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_9
component[4]=killComponent,m1,2,1,testproxy_connect10
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} "
...
component[2]=wsDriverNocheck,m1,connect/${xml[${n}]}.xml,publish,-o_-l_9
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_9
component[4]=killComponent,m1,2,1,testproxy_connect12
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} "
...
component[5]=killComponent,m1,2,1,testproxy_connect13
...
component[2]=wsDriverNocheck,m1,connect/${xml[${n}]}.xml,publish,-o_-l_9
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_9
component[4]=killComponent,m1,2,1,testproxy_connect15
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]} "
...
#----------------------------------------------------
# Test Case 21 - testproxy_connect21
#----------------------------------------------------
xml[${n}]="testproxy_connect21"
timeouts[${n}]=90
...
component[4]=runCommand,m1,../common/serverKillRestart.sh,1,testproxy_connect21
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]}"
((n+=1))

#----------------------------------------------------
# Test Case 22 - testproxy_connect22
#----------------------------------------------------
xml[${n}]="testproxy_connect22"
timeouts[${n}]=90
scenario[${n}]="${xml[${n}]} - Test that RETAINed messages are available after server fail/restart [ ${xml[${n}]}.xml ]"
component[1]=sync,m1
component[2]=wsDriver,m1,connect/${xml[${n}]}.xml,publish,-o_-l_7
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_7,"-s|BITFLAG=-Djava.util.logging.config.file=./jsr47tofile.properties"
component[4]=runCommand,m1,../common/serverKillRestart.sh,1,testproxy_connect22
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]}"
((n+=1))

#----------------------------------------------------
# Test Case 23 - testproxy_connect23
#----------------------------------------------------
xml[${n}]="testproxy_connect23"
timeouts[${n}]=90
scenario[${n}]="${xml[${n}]} - More RETAINed messages tests [ ${xml[${n}]}.xml ]"
component[1]=sync,m1
component[2]=wsDriver,m1,connect/${xml[${n}]}.xml,publish,-o_-l_7
component[3]=wsDriver,m1,connect/${xml[${n}]}.xml,receive,-o_-l_7,"-s|BITFLAG=-Djava.util.logging.config.file=./jsr47tofile.properties"
component[4]=runCommand,m1,../common/serverKillRestart.sh,1,testproxy_connect23
components[${n}]="${component[1]} ${component[2]} ${component[3]} ${component[4]}"
((n+=1))
...
if [[ "$A1_LDAP" == "FALSE" ]] ; then
    ...
    #----------------------------------------------------
    xml[${n}]="proxy_connect_M1_LDAP_cleanup"
