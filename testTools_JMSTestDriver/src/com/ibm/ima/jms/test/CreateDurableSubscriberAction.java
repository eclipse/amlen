...
public class CreateDurableSubscriberAction extends ApiCallAction {
     ...
     * @param trWriter
     */
    public CreateDurableSubscriberAction(Element config, DataRepository dataRepository,
            TrWriter trWriter) {
    ...
    protected boolean invokeApi() throws JMSException {
        ...
        if (!(dest instanceof Topic)) {
            ...
            try {
                ...
                throw new JMSException("Null pointer exception", "JMSTDNullPtr");
            }
        } else {
            try {
                Topic topic = (Topic) dest;
