...
public class CloseSessionAction extends ApiCallAction {
     ...
     * @param trWriter
     */
    public CloseSessionAction(Element config, DataRepository dataRepository,
            TrWriter trWriter) {
    ...
    protected boolean invokeApi() throws JMSException {
        final Session sess = (Session) _dataRepository.getVar(_sessionID);
        if (sess == null) {
