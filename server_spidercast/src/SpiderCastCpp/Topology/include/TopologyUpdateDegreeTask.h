 ...
 *-----------------------------------------------------------------
 * $Log: TopologyUpdateDegreeTask.h,v $
...
#ifndef TOPOLOGYUPDATEDEGREETASK_H_
#define TOPOLOGYUPDATEDEGREETASK_H_
...
class TopologyUpdateDegreeTask: public AbstractTask
{
private:
	TopologyManager_SPtr topoMgr_SPtr;

public:
	TopologyUpdateDegreeTask(CoreInterface& core);
	virtual ~TopologyUpdateDegreeTask();
...
#endif /* TOPOLOGYUPDATEDEGREETASK_H_ */
