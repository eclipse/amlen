 ...
 *-----------------------------------------------------------------
 * $Log: TopologyRandomConnectTask.h,v $
...
#ifndef TOPOLOGYRANDOMCONNECTTASK_H_
#define TOPOLOGYRANDOMCONNECTTASK_H_
...
class TopologyRandomConnectTask: public AbstractTask
{
private:
	TopologyManager_SPtr topoMgr_SPtr;

public:
	TopologyRandomConnectTask(CoreInterface& core);
	virtual ~TopologyRandomConnectTask();
...
#endif /* TOPOLOGYRANDOMCONNECTTASK_H_ */
