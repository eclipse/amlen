...
//
/*
 * TopologyDiscoveryReplySendTask.h
 *
 ...
 *-----------------------------------------------------------------
 * $Log: TopologyDiscoveryReplySendTask.h,v $
...
#ifndef TOPOLOGYDISCOVERYREPLYSENDTASK_H_
#define TOPOLOGYDISCOVERYREPLYSENDTASK_H_
...
class TopologyDiscoveryReplySendTask: public AbstractTask
{
private:
	TopologyManager_SPtr topoMgr_SPtr;

public:
	TopologyDiscoveryReplySendTask(CoreInterface& core);
	virtual ~TopologyDiscoveryReplySendTask();
...
#endif /* TOPOLOGYDISCOVERYREPLYSENDTASK_H_ */
