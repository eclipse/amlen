...
public class JmsMessage {
	...
	public static String imaQueue= "ImaQueue:";
	public static String mqTopic = "topic://";
	public static String mqQueue= "queue://";
	
	public static enum MESSAGE_TYPE {TEXT, STREAM, MAP, BYTES, OBJECT, BASE, SERIAL, LARGE}
	...
	public static Message createMessageBody(Session session, MESSAGE_TYPE type) throws JMSException
	{
		...
		else if (type.equals(MESSAGE_TYPE.LARGE))
		{
			msg = createLargeMessage(session, 1, 0);
			if(Trace.traceOn())
			{
				Trace.trace("Large Message generated");
			}
		}
