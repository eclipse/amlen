...
#
# Description:
#   This script executes ISM test bucket for:  svt_client_tests.
#
# Input Parameters:
...
# SVT Test Bucket Scenario (group 1) standalone TO ISM
export component_sleep=5
run01Result=0
RUNCMD="../scripts/run-scenarios.sh STD_ESXHARegressionValidate-01.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
run01Result=$?
