...
xml[${n}]="MQCON_MSGCON_36"
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - com.ibm.ima.mqcon.msgconversion 1 JMS Object message is published to MQ topic and subscribed by an IMA MQTT consumer [1 Pub; 1 Sub] with Topic Subscription"
timeouts[${n}]=60

# Set up the components for the test in the order they should start
component[1]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup_mqconnectivity_msgCon2|-c|policy_config.cli"
component[2]=javaAppDriverRC,m1,"-e|com.ibm.ima.mqcon.msgconversion.JmsObjectToMqtt_MqToIma,-o|${A1_IPv4_1}|16102|${MQSERVER1_IP}|1424|MQC_SVT_MSGCONVERSION|UK/ENGLAND/AVON|UK/SCOTLAND/ARGYLL|60000"
