...
xml[${n}]="MQCON_MSGCON_26"
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - com.ibm.ima.mqcon.msgconversion 1 JMS Bytes message is published to IMA topic and subscribed by an IMA MQTT consumer [1 Pub; 1 Sub]"
timeouts[${n}]=15

# Set up the components for the test in the order they should start
component[1]=javaAppDriverRC,m1,"-e|com.ibm.ima.mqcon.msgconversion.JmsBytesToMqtt_ImaToIma,-o|${A1_IPv4_1}|16102|UK/ENGLAND/DERBY|60000"
