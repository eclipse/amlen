...
xml[${n}]="MQCON_MSGCON_28"
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - com.ibm.ima.mqcon.msgconversion 1 JMS Base message is published to IMA topic and subscribed by an MQ MQTT consumer [1 Pub; 1 Sub]"
timeouts[${n}]=60

# Set up the components for the test in the order they should start
component[1]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup_mqconnectivity_msgCon1|-c|policy_config.cli"
component[2]=javaAppDriverRC,m1,"-e|com.ibm.ima.mqcon.msgconversion.JmsBaseToMqtt_ImaToMq,-o|${A1_IPv4_1}|16102|${MQSERVER1_IP}|1893|MQC_SVT_MSGCONVERSION|UK/ENGLAND/WINCHESTER|UK/SCOTLAND/DUNDEE|60000"
