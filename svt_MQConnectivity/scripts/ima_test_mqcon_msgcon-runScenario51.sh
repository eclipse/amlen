...
xml[${n}]="MQCON_MSGCON_51"
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - com.ibm.ima.mqcon.msgconversion Send retained messages to MQ topic with IMS consumer"
timeouts[${n}]=240

# Set up the components for the test in the order they should start
component[1]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup_mqconnectivity_msgCon4|-c|policy_config.cli"
component[2]=javaAppDriverRC,m1,"-e|com.ibm.ima.mqcon.msgconversion.JmsRetained_MqToIma,-o|${A1_IPv4_1}|16102|${MQSERVER1_IP}|1424|MQC_SVT_MSGCONVERSION|mquser|/opt/mqm_v7.5/bin|UK/ENGLAND/NORFOLK|UK/SCOTLAND/BUTE|60000"
