...
xml[${n}]="MQCON_MSGCON_56"
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - com.ibm.ima.mqcon.msgconversion MQTT Retained message sent to topic with IMA publisher and mqtt subscriber"
timeouts[${n}]=15

# Set up the components for the test in the order they should start
component[1]=javaAppDriverRC,m1,"-e|com.ibm.ima.mqcon.msgconversion.MqttRetained_ImaToIma,-o|${A1_IPv4_1}|16102|UK/ENGLAND/YORK|60000"
