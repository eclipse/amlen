...
xml[${n}]="MQCON_MSGCON_55"
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - com.ibm.ima.mqcon.msgconversion MQTT Retained message sent to IMA topic with MQ mqtt consumer"
timeouts[${n}]=300

# Set up the components for the test in the order they should start
component[1]=cAppDriverLogWait,m1,"-e|../scripts/run-cli.sh","-o|-s|setup_mqconnectivity_msgCon3|-c|policy_config.cli"
component[2]=javaAppDriverRC,m1,"-e|com.ibm.ima.mqcon.msgconversion.MqttRetained_ImaToMq,-o|${A1_IPv4_1}|16102|${MQSERVER1_IP}|1893|MQC_SVT_MSGCONVERSION|mquser|/opt/mqm_v7.5/bin|UK/ENGLAND/OXFORD|UK/SCOTLAND/MORAY|60000"
