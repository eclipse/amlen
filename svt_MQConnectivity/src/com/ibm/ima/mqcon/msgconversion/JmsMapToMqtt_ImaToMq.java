...
/**
 * Test sends a JMS Map message to an IMA topic
 ...
 * Message = Map and non persistent
 * Headers = Set
 *
 */
public class JmsMapToMqtt_ImaToMq extends JmsToMqttImaToMqBaseClass{
	
	
	public static void main(String[] args) 
	{
		JmsMapToMqtt_ImaToMq testClass = new JmsMapToMqtt_ImaToMq();
	...
	public void runTest()
	{
		try
		{
			...
			msg = JmsMessage.createMessage(producerSession, JmsMessage.MESSAGE_TYPE.MAP);
			if(Trace.traceOn())
			{
