...
public abstract class JmsMqToImaBaseClass extends TestHelper{
	...
	public void setUpClients()
	{
		try
		{
			...
			{
				producerSession = producerJMSSession.getSession(JmsSession.CLIENT_TYPE.MQ, mqhostname, mqport, mqqueuemanager, true, Session.AUTO_ACKNOWLEDGE);
			}
			if(!retained)
			{
				if(Trace.traceOn())
