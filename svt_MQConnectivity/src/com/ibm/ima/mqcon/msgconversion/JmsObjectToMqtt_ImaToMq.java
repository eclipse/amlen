...
/**
 * Test sends a JMS Object message to an IMA topic
 ...
 * Message = Object and non persistent
 * Headers = Set
 *
 */
public class JmsObjectToMqtt_ImaToMq extends JmsToMqttImaToMqBaseClass{
	
	
	public static void main(String[] args) 
	{
		JmsObjectToMqtt_ImaToMq testClass = new JmsObjectToMqtt_ImaToMq();
	...
	public void runTest()
	{
		try
		{
			...
			msg = JmsMessage.createMessage(producerSession, JmsMessage.MESSAGE_TYPE.OBJECT);
			if(Trace.traceOn())
			{
