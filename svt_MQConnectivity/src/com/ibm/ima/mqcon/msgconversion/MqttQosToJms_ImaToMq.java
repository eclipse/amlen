...
/**
 * Test sends a MQTT message to an IMA topic
 ...
 *
 */
public class MqttQosToJms_ImaToMq extends MqttToJmsImaToMqBaseClass {
	
	public static void main(String[] args) 
	{
		MqttQosToJms_ImaToMq testClass = new MqttQosToJms_ImaToMq();
