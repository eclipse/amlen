...
public abstract class MqttMqToImaBaseClass extends TestHelper{
	...
	public void setUpClients()
	{
		try
		{
			if(Trace.traceOn())
			{
				Trace.trace("Creating the default IMA MQTT producer and MQ consumer");
			}
			...
			mqttProducerConnection = new MqttConnection(mqhostname, mqport, clientID, true, 2);
			...
			topic = producer.getTopic(mqDestinationName);
