 ...
 *
 */
public class JmsQosToMqtt_ImaToIma extends JmsToMqttImaBaseClass{
	...
	{
		JmsQosToMqtt_ImaToIma testClass = new JmsQosToMqtt_ImaToIma();
	...
	public void runTest()
	{
		try
		{
			if(Trace.traceOn())
			{
				Trace.trace("Creating the default producer session (ACK disabled) for IMA and consumer client for IMA");
			}
