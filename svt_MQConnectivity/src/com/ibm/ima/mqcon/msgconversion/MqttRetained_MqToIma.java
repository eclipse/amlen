...
public class MqttRetained_MqToIma extends MqttMqToImaBaseClass{
	...
	public static void main(String[] args) {
		...
		retained = true;
		MqttRetained_MqToIma testClass = new MqttRetained_MqToIma();
	...
	public void runTest()
	{
		try
		{
			...
			token = topic.publish(msg1);
			token.waitForCompletion(5000);
			StaticUtilities.sleep(5000); // need to give the message a chance to get across
