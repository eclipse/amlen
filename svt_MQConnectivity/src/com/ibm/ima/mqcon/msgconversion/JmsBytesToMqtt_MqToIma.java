...
/**
 * Test sends a JMS Bytes message to an MQ topic
 ...
 *
 */
public class JmsBytesToMqtt_MqToIma extends JmsToMqttMqToImaBaseClass{
	
	public static void main(String[] args) 
	{
		JmsBytesToMqtt_MqToIma testClass = new JmsBytesToMqtt_MqToIma();
