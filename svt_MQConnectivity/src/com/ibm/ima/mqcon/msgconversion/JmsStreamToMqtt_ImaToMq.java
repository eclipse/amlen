...
/**
 * Test sends a JMS Stream message to an IMA topic
 ...
 *
 */
public class JmsStreamToMqtt_ImaToMq extends JmsToMqttImaToMqBaseClass{
	
	
	public static void main(String[] args) 
	{
		JmsStreamToMqtt_ImaToMq testClass = new JmsStreamToMqtt_ImaToMq();
