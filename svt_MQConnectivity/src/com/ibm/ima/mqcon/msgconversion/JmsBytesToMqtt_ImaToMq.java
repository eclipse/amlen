...
/**
 * Test sends a JMS Bytes message to an IMA topic
 ...
 *
 */
public class JmsBytesToMqtt_ImaToMq extends JmsToMqttImaToMqBaseClass{
	
	
	public static void main(String[] args) 
	{
		JmsBytesToMqtt_ImaToMq testClass = new JmsBytesToMqtt_ImaToMq();
	...
	public void runTest()
	{
		try
		{
			...
			msg = JmsMessage.createMessage(producerSession, JmsMessage.MESSAGE_TYPE.BYTES);
			if(Trace.traceOn())
			{
