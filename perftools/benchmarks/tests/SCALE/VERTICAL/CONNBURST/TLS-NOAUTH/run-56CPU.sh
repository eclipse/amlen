...
# Reset connection latency statistics every 160 seconds (-rl 160) and latency histogram units are in milliseconds (-cu 1e-3).  
# Clients remain connected for 160 seconds (-l 160)
