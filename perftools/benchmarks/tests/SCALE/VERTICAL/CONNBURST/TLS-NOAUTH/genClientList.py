...
# SCALE-VERTICAL-CONNBURST-TLS-NOAUTH benchmark test.
#
######################################################################################
CLIENTLIST_FILE="SCALE-VERTICAL-CONNBURST-TLS-NOAUTH.json"
NUMCLIENTS = 1e6
...
def readArgs():
    ...
    parser = argparse.ArgumentParser(description='Creates the mqttbench client list file for the SCALE.VERTICAL.CONNBURST.TLS.NOAUTH benchmark', formatter_class=argparse.RawTextHelpFormatter)
