...
# Reset connection latency statistics every 5060 seconds (-rl 5060) and latency histogram units are in milliseconds (-cu 1e-3).  
# Clients remain connected for 5060 seconds (-l 5060)
mqttbench -cl $TESTNAME.json -T 0x20 -snap connects,connlatency 4 -cu 1e-3 -csv $TESTVARIANT.stats.csv -lcsv $TESTVARIANT.latency.csv -rl 5060 -l 5060 
