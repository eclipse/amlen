...
export TESTVARIANT=${TESTNAME}-Q1-${NUMTOPICS}TOPICS-${NUMPUBBERS}PUB-${NUMSUBBERS}SUB
export TESTVARIANT_DS=${TESTNAME}-Q1-${NUMTOPICS}TOPICS-${NUMPUBBERS}PUB-${NUMSUBBERS}SUB-DELETESTATE
