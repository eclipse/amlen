...
######################################################################################
CLIENTLIST_FILE_PREFIX="TPUT-BROADCAST-Q1-"
...
def createPUBClient(id, version, dstip, topicNum, deleteState):
    ...
    topic = MBTopic("broadcast/q1-" + NUMTOPICSTRING + "TOPICS-" + NUMPUBSTRING + "PUB-" + NUMSUBSTRING + "SUB/broadcast" + str(topicNum))
    topic.qos = 1
...
def createSUBClient(id, version, dstip, topicNum, deleteState):
    ...
    sub = MBTopic("broadcast/q1-" + NUMTOPICSTRING + "TOPICS-" + NUMPUBSTRING + "PUB-" + NUMSUBSTRING + "SUB/broadcast" + str(topicNum))
    sub.qos = 1
