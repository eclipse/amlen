...
#  *  -1, no cpu affinity
#  * 100, transacted session (100 msgs/commit)
...
java $JVM_COMMON_ARGS $JVM_IBM_ARGS $JVM_DEBUG_ARGS -cp $CLASSPATH JMSBenchTest -d 0 -mt ss -rx -1:100:3:2:1:jmsfanin/q1-jms/#:1:1:1:$NUMSUBBERS:0 -T 0x1 -u 1e-6 -snap 4 -lcsv ${TESTVARIANT}-MSG-${MSGSIZE}-jmsbench.csv
