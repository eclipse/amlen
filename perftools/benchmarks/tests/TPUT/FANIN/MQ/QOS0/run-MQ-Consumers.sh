...
# Open the IMA2MQ.NP.QUEUE local queue object to receive from (-d IMA2MQ.NP.QUEUE)
# Number of consumer worker threads (-nt $NUMSUBBERS)
# LD_LIBRARY_PATH set by perftools/benchmarks/baseenv.sh
mqbench -tc Receiver -d IMA2MQ.NP.QUEUE -nt $NUMSUBBERS
