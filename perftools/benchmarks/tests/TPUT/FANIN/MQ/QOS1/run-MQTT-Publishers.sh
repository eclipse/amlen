...
export TESTNAME=TPUT-FANIN-MQ-Q1-${NUMPUBBERS}PUB
export TESTNAME_DS=TPUT-FANIN-MQ-Q1-${NUMPUBBERS}PUB-DELETESTATE
export TESTVARIANT=${TESTNAME}-Q1-QMgrs-${NUMQMGR}-MQCONN-${NUMCONN_PER_QMGR}-${NUMPUBBERS}PUB-${NUMSUBBERS}SUB
