...
export TESTVARIANT=${TESTNAME}-Q2-PARTITION-${NUMPUBBERS}PUB-${NUMSUBBERS}SUB
export TESTVARIANT_DS=${TESTNAME}-Q2-PARTITION-${NUMPUBBERS}PUB-${NUMSUBBERS}SUB-DELETESTATE
