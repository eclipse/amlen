...
export TESTVARIANT=${TESTNAME}-Q1-PARTITION-${NUMPUBBERS}PUB-${NUMSUBBERS}SUB
export TESTVARIANT_DS=${TESTNAME}-Q1-PARTITION-${NUMPUBBERS}PUB-${NUMSUBBERS}SUB-DELETESTATE
