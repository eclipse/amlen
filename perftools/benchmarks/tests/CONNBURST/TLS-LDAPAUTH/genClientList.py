...
######################################################################################## 
#
# This script generates the mqttbench client list for running the CONNBURST-TLS-LDAPAUTH
# benchmark test.
#
########################################################################################
CLIENTLIST_FILE="CONNBURST-TLS-LDAPAUTH.json"
NUMCLIENTS = 1e6
USERNAME_PREFIX="h"
PASSWORD="svtpvtpass"
...
def readArgs():
    ...
    parser = argparse.ArgumentParser(description='Creates the mqttbench client list file for the CONNBURST.TLS.LDAPAUTH benchmark', formatter_class=argparse.RawTextHelpFormatter)
