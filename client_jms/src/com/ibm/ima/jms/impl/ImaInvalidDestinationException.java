...
public class ImaInvalidDestinationException extends InvalidDestinationException implements ImaJmsException {
    private static final long serialVersionUID = 6667337335099177671L;
    ...
    /*
     * Create an InvalidDestinationException with a string.
     * @param errorcode  The error code for the exception
     * @param reason     The reason as a string
     */
    public ImaInvalidDestinationException(String errorcode, String reason) {
    ...
    /*
     * Create an InvalidDestinationException with a reason message.
     * @param errorcode  The error code for the exception
     * @param reasonmsg  The reason as a Java message format
     * @param repl       An array of replacement data
     */
    public ImaInvalidDestinationException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaInvalidDestinationException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsExceptionImpl.formatException(reasonmsg, repl, errorcode), errorcode);
    	msgfmt = ImaJmsExceptionImpl.getMessageFromBundle(Locale.ROOT, errorcode, reasonmsg);
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "InvalidDestinationException: " + getErrorCode() + " " + getMessage();
    }
}
