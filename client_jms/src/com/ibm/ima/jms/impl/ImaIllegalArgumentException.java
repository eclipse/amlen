...
public class ImaIllegalArgumentException extends IllegalArgumentException implements
		ImaJmsException {
    String errCode = null;
    String msgfmt = null;
    Object[] repl = null;
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8751839260702727585L;
	...
	public ImaIllegalArgumentException(String errCode, String message) {
	...
	public ImaIllegalArgumentException(String errCode, String message, Object ...repl) {
	...
	public ImaIllegalArgumentException(String errCode, Throwable cause, String message, Object ...repl) {
    ...
    public String toString() {
        return "IllegalArgumentException: " + getErrorCode() + " " + getMessage();
    }
