...
public class ImaInvalidClientIDException extends InvalidClientIDException implements ImaJmsException {
     ...
     */
    public ImaInvalidClientIDException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaInvalidClientIDException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsExceptionImpl.formatException(reasonmsg, repl, errorcode), errorcode);
        this.repl = repl;
    	msgfmt = ImaJmsExceptionImpl.getMessageFromBundle(Locale.ROOT, errorcode, reasonmsg);
        if (cause != null) {
    ...
    public String toString() {
        return "InvalidClientIDException: " + getErrorCode() + " " + getMessage();
    }
}
