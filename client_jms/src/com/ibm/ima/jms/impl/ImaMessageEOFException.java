...
public class ImaMessageEOFException extends MessageEOFException implements ImaJmsException {
    private static final long serialVersionUID = -5973664263345283548L;
    ...
    /*
     * Create a MessageEOFException with a reason string.
     * @param errorcode  The error code for the exception
     * @param reasonmsg  The reason as string
     */
    public ImaMessageEOFException(String errorcode, String reason) {
    ...
    /*
     * Create a MessageEOFException with a reason message.
     * @param errorcode  The error code for the exception
     * @param reasonmsg  The reason as a Java message format
     * @param repl       An array of replacement data
     */
    public ImaMessageEOFException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaMessageEOFException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsExceptionImpl.formatException(reasonmsg, repl, errorcode), errorcode);
    	msgfmt = ImaJmsExceptionImpl.getMessageFromBundle(Locale.ROOT, errorcode, reasonmsg);
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "MessageEOFException: " + getErrorCode() + " " + getMessage();
    }
}
