...
public class ImaMessageNotWriteableException extends MessageNotWriteableException implements ImaJmsException {
     ...
     */
    public ImaMessageNotWriteableException(String errorcode, String reason) {
     ...
     */
    public ImaMessageNotWriteableException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaMessageNotWriteableException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsExceptionImpl.formatException(reasonmsg, repl, errorcode), errorcode);
    	msgfmt = ImaJmsExceptionImpl.getMessageFromBundle(Locale.ROOT, errorcode, reasonmsg);
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "MessageNotWritableException: " + getErrorCode() + " " + getMessage();
    }
}
