 ...
 * 
 */
public class ImaQueue extends ImaDestination implements Queue, Serializable, Referenceable, ObjectFactory {
	
	private static final long serialVersionUID = 7739417804935580215L;
	...
	public ImaQueue(String name) {
		super(name);
		props.put("ObjectType", "queue");
	}
    ...
    public Reference getReference() throws NamingException {
        if (this instanceof ImaTemporaryQueue) {
        ...
        Reference ref = new Reference(ImaQueue.class.getName(), ImaQueue.class.getName(), null);
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx, Hashtable<?, ?> environment) throws Exception {
        ...
        ImaQueue dest = new ImaQueue(dname);
    ...
    public String toString() {
        ...
        return obj==null ? "IMAQueue@"+hashCode() : "ImaQueue:"+obj;
    }
