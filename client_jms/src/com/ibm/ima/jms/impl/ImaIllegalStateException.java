...
public class ImaIllegalStateException extends IllegalStateException implements ImaJmsException {
    private static final long serialVersionUID = -1092988663965787175L;
     ...
     */
    public ImaIllegalStateException(String errorcode, String reason ) {
     ...
     */
    public ImaIllegalStateException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaIllegalStateException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsExceptionImpl.formatException(reasonmsg, repl, errorcode), errorcode);
    	msgfmt = ImaJmsExceptionImpl.getMessageFromBundle(Locale.ROOT, errorcode, reasonmsg);
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "IllegalStateException: " + getErrorCode() + " " + getMessage();
    }
    
    /* Exceptions for Java EE clients */
    public static ImaIllegalStateException apiNotAllowedForConnectionProxy(String method) {
        return new ImaIllegalStateException("CWLNC2562","A call to the {0} method failed because this method cannot be called on a Java EE client application Connection object.", method);
    }
    
    public static ImaIllegalStateException apiNotAllowedForConsumerProxy(String method) {
        return new ImaIllegalStateException("CWLNC2564","A call to the {0} method failed because this method cannot be called on a Java EE client application MessageConsumer object.", method);
    }
    
    public static ImaIllegalStateException apiNotAllowedForSessionProxy(String method) {
        return new ImaIllegalStateException("CWLNC2565","A call to the {0} method failed because this method cannot be called on a Java EE client application Session object.", method);
    }
}
