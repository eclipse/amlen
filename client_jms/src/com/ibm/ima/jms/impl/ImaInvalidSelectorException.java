...
public class ImaInvalidSelectorException extends InvalidSelectorException implements ImaJmsException {
     ...
     */
    public ImaInvalidSelectorException(String errorcode, String reason ) {
     ...
     */
    public ImaInvalidSelectorException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaInvalidSelectorException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsExceptionImpl.formatException(reasonmsg, repl, errorcode), errorcode);
    	msgfmt = ImaJmsExceptionImpl.getMessageFromBundle(Locale.ROOT, errorcode, reasonmsg);
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "InvalidSelectorException: " + getErrorCode() + " " + getMessage();
    }
}
