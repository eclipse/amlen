...
unsigned long long g_msg_number=1;    
unsigned long long g_publish_count=0; 
unsigned long long g_subscribe_count=0;
unsigned long long g_warning_count=0;
...
unsigned long long g_lastActiveTime=0;
unsigned long long g_lastActiveCount=0;
unsigned long long g_verifyStillActive=0*MICROS_PER_SECOND;
