...
component[1]=javaAppDriver,m1,"-e|com.ibm.ima.samples.jms.JMSSampleAdmin,-o|-c|file:.|../common/JMSAdminSample2.config"
component[2]=javaAppDriver,m2,"-e|com.ibm.ima.samples.jms.JMSSampleAdmin,-o|-c|file:.|../common/JMSAdminSample2.config"
...
test_template_compare_string[1]="connection SampleconnFactory2";
...
# MQTTv3 C Client
component[1]=cAppDriver,m1,"-e|mqttsample_array,-o|-a|publish|-q|$qos|-t|/topic/A/1|-s|${A1_IPv4_1}:17772|-n|${cmsgs}|-w|2000|-x|86WaitForCompletion=1"
test_template_compare_string[1]="Published ${cmsgs} messages";
component[2]=cAppDriver,m1,"-e|mqttsample,-o|-a|subscribe|-q|$qos|-t|/topic/A/2|-s|${A1_IPv4_1}:17772|-n|${jmsmsgs}"
test_template_compare_string[2]="Received ${jmsmsgs} messages.";
component[3]=cAppDriver,m2,"-e|mqttsample,-o|-a|subscribe|-q|$qos|-t|/topic/A/+|-s|${A1_IPv4_1}:17772|-n|$((${jmsmsgs}+${cmsgs}))"
test_template_compare_string[3]="Received $((${jmsmsgs}+${cmsgs})) messages.";
component[4]=cAppDriver,m1,"-e|mqttsample,-o|-a|subscribe|-q|$qos|-t|/topic/+/1|-s|${A1_IPv4_1}:17772|-n|$((${cmsgs}+${jmsgs}))"
test_template_compare_string[4]="Received $((${cmsgs}+${jmsgs})) messages.";
component[5]=cAppDriver,m2,"-e|mqttsample,-o|-a|subscribe|-q|$qos|-t|/topic/#|-s|${A1_IPv4_1}:17772|-n|$((${cmsgs}+${jmsmsgs}+${jmsgs}))"
test_template_compare_string[5]="Received $((${cmsgs}+${jmsmsgs}+${jmsgs})) messages.";

# JMS Client
component[6]=javaAppDriver,m1,"-e|com.ibm.ima.samples.jms.JMSSample,-o|-a|publish|-t|topicA2|-jc|file:.|-jx|com.sun.jndi.fscontext.RefFSContextFactory|-jcf|SampleconnFactory2|-n|${jmsmsgs}|-w|2000"
test_template_compare_string[6]="sent ${jmsmsgs} messages to topic topicA2(/topic/A/2)";
component[7]=javaAppDriver,m1,"-e|com.ibm.ima.samples.jms.JMSSample,-o|-a|subscribe|-t|topicB1|-jc|file:.|-jx|com.sun.jndi.fscontext.RefFSContextFactory|-jcf|SampleconnFactory2|-n|${jmsgs}"
test_template_compare_string[7]="received ${jmsgs} messages.";
component[8]=javaAppDriver,m2,"-e|com.ibm.ima.samples.jms.JMSSample,-o|-a|subscribe|-t|topicBPlus|-jc|file:.|-jx|com.sun.jndi.fscontext.RefFSContextFactory|-jcf|SampleconnFactory2|-n|${jmsgs}"
test_template_compare_string[8]="received ${jmsgs} messages.";
component[9]=javaAppDriver,m1,"-e|com.ibm.ima.samples.jms.JMSSample,-o|-a|subscribe|-t|topicPlus|-jc|file:.|-jx|com.sun.jndi.fscontext.RefFSContextFactory|-jcf|SampleconnFactory2|-n|$((${cmsgs}+${jmsgs}))"
test_template_compare_string[9]="received $((${cmsgs}+${jmsgs})) messages.";
component[10]=javaAppDriver,m2,"-e|com.ibm.ima.samples.jms.JMSSample,-o|-a|subscribe|-t|topicPound|-jc|file:.|-jx|com.sun.jndi.fscontext.RefFSContextFactory|-jcf|SampleconnFactory2|-n|$((${cmsgs}+${jmsmsgs}+${jmsgs}))"
test_template_compare_string[10]="received $((${cmsgs}+${jmsmsgs}+${jmsgs})) messages.";

# MQTTv3 Java Client
component[11]=javaAppDriver,m1,"-e|svt.mqtt.mq.MqttSample,-o|-a|publish|-q|$qos|-t|/topic/B/1|-s|tcp://${A1_IPv4_1}:17772|-n|${jmsgs}|-w|1500"
test_template_compare_string[11]="Published ${jmsgs} messages to topic /topic/B/1";
component[12]=javaAppDriver,m1,"-e|com.ibm.ima.samples.mqttv3.MqttSample,-o|-a|subscribe|-q|$qos|-t|/topic/A/2|-s|tcp://${A1_IPv4_1}:17772|-n|${jmsmsgs}"
test_template_compare_string[12]="Received ${jmsmsgs} messages.";
component[13]=javaAppDriver,m2,"-e|com.ibm.ima.samples.mqttv3.MqttSample,-o|-a|subscribe|-q|$qos|-t|/topic/A/+|-s|tcp://${A1_IPv4_1}:17772|-n|$((${jmsmsgs}+${cmsgs}))"
test_template_compare_string[13]="Received $((${jmsmsgs}+${cmsgs})) messages.";
msgs=$((${cmsgs}+${jmsgs}))
component[14]=javaAppDriver,m1,"-e|com.ibm.ima.samples.mqttv3.MqttSample,-o|-a|subscribe|-q|$qos|-t|/topic/+/1|-s|tcp://${A1_IPv4_1}:17772|-n|${msgs}"
test_template_compare_string[14]="Received ${msgs} messages.";
msgs=$((${cmsgs}+${jmsmsgs}+${jmsgs}))
component[15]=javaAppDriver,m2,"-e|com.ibm.ima.samples.mqttv3.MqttSample,-o|-a|subscribe|-q|$qos|-t|/topic/#|-s|tcp://${A1_IPv4_1}:17772|-n|${msgs}"
