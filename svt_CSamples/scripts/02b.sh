...
component[8]=searchLogsEnd,m2,${xml[${n}]}_m2.comparetest,9
#component[9]=cAppDriver,m1,"-e|mqttbench,-o|-d|30|-snap|5|-r|1|-tx|1:0:/bench/A/1:1:-1000:1:0|-rx|1:1:/bench/A/1:1:-1000:1:0|","-s|IMAServer=${A1_IPv4_1}|IMAPort=16102"
...
#
# Set up the components for the test in the order they should start
component[1]=cAppDriver,m1,"-e|mqttsample_array,-o|-a|publish|-q|0|-t|/topic/A/1|-s|${A1_IPv4_1}:16102|-n|1000000|-x|testCriteriaPctMsg=50|-x|verifyStillActive=60|-w|50000"
component[2]=cAppDriver,m1,"-e|mqttsample_array,-o|-a|subscribe|-q|0|-t|/topic/A/1|-s|${A1_IPv4_1}:16102|-n|1000000|-x|testCriteriaPctMsg=50|-x|verifyStillActive=60"
component[3]=cAppDriver,m2,"-e|mqttsample_array,-o|-a|subscribe|-q|0|-t|/topic/A/+|-s|${A1_IPv4_1}:16102|-n|1000000|-x|testCriteriaPctMsg=50|-x|verifyStillActive=60"
component[4]=cAppDriver,m1,"-e|mqttsample_array,-o|-a|subscribe|-q|0|-t|/topic/+/1|-s|${A1_IPv4_1}:16102|-n|1000000|-x|testCriteriaPctMsg=50|-x|verifyStillActive=60"
component[5]=cAppDriver,m2,"-e|mqttsample_array,-o|-a|subscribe|-q|0|-t|/topic/#|-s|${A1_IPv4_1}:16102|-n|1000000|-x|testCriteriaPctMsg=50|-x|verifyStillActive=60"
