...
#
#   11/26/12 - Refactored  ismAutoMQTT_C_Sample.sh 
#
#
...
RUNCMD="../scripts/run-scenarios.sh  00.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )


#run specific tests for Softlayer 
if [ "${A1_HOST_OS:0:4}" == "CCI_" ] ;then

RUNCMD="../scripts/run-scenarios.sh  01b.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )

RUNCMD="../scripts/run-scenarios.sh  02b.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )
...
RUNCMD="../scripts/run-scenarios.sh  10b.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )
...
RUNCMD="../scripts/run-scenarios.sh  10.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )

RUNCMD="../scripts/run-scenarios.sh  12.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )

RUNCMD="../scripts/run-scenarios.sh  13.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )

RUNCMD="../scripts/run-scenarios.sh  15.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )
...
RUNCMD="../scripts/run-scenarios.sh  17.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )

RUNCMD="../scripts/run-scenarios.sh  20.sh ${logfile}"
echo Running command: ${RUNCMD}
$RUNCMD
totalResults=$( expr ${totalResults} + $? )
...
echo "---------------------------------------------------------"
echo " exit totalResults = $totalResults "
echo "---------------------------------------------------------"
