...
ha_pair_up_part3b_helper(){
    ...
    if [ "$flag" == "PRIMARY" ] ;then
        ssh_wrapper -nx  admin@$ima "imaserver update HighAvailability StartupMode=StandAlone "
    fi
    ...
    if [ "$flag" == "PRIMARY" ] ;then
        ...
        ssh_wrapper -nx  admin@$ima "imaserver update HighAvailability StartupMode=AutoDetect "
        echo "=================================="
        echo "`date` step k..."
        echo "=================================="
        stop_server $ima
