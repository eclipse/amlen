...
publish_count=1000000000;  # Each publisher publishes this many messages (all on same topic)
...
ismserver=ssl://10.10.10.10:16111
#ismserver=10.10.3.22:16901
#ismserver=10.10.10.10:16102
other_options="-S trustStore=CAfile.pem"
...
while (($x<=$publish_client)) ; do
    ...
    #else
        ./$TEST_APP -o log.p.$x -a publish_wait $other_options -s $ismserver -n $publish_count -q 0 -z  $publish_connections_per_client &
