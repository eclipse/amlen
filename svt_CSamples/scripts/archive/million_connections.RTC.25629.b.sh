...
if [ "$ACTION" == "ALL" -o "$ACTION" == "LAUNCH" -o "$ACTION" == "LAUNCH499800" -o "$ACTION" == "LAUNCH249900"   -o "$ACTION" == "LAUNCH83300"  -o "$ACTION" == "LAUNCH99600"   ] ; then
    ...
    if [ "$ACTION" == "LAUNCH" ] ;then
        ...
        echo "---------------------------------------"
        params="980 60"
    elif [ "$ACTION" == "LAUNCH499800" ] ;then
        echo "---------------------------------------"
        echo " fan out to 980*30*17 connections - 499800 connections total. Stop just before 1M "
        echo "---------------------------------------"
        params="980 30"
    elif [ "$ACTION" == "LAUNCH249900" ] ;then
        echo "---------------------------------------"
        echo " fan out to 980*15*17 connections - 249900 connections total. Stop just before 1M "
        echo "---------------------------------------"
        params="980 15"
    elif [ "$ACTION" == "LAUNCH99600" ] ;then
        echo "---------------------------------------"
        echo " fan out to 980*6*17 connections - 99600 connections total. Stop just before 1M "
        echo "---------------------------------------"
        params="980 6"
    elif [ "$ACTION" == "LAUNCH83300" ] ;then
        echo "---------------------------------------"
        echo " fan out to 980*5*17 connections - 83300 connections total. Stop just before 1M "
        echo "---------------------------------------"
        params="980 5"
    else
        echo "---------------------------------------"
        echo " fan out to 980*60*17 connections - 999600 connections total. Stop just before 1M "
        echo "---------------------------------------"
        params="980 60" # default
    fi

    for x in {2..18} ; do
	    if [ -n "$HA_END" ] ; then
            ./fan_out.sh $x $params 100 0 0 10.10.$x.${IMAeth610net_END}:16102 log.s.$x 10.10.$x.${HA_END}:16102 > log.fa.$x & 
        else
            ./fan_out.sh $x $params 100 0 0 10.10.$x.${IMAeth610net_END}:16102 log.s.$x "" > log.fa.$x & 
        fi
    done
