...
import com.ibm.ism.test.tasks.NavigateTabTask;
 ...
 *
 */
public class FirstStepsTest_11 {
	...
	public static void main(String[] args) {
		...
		VisualReporter.startLogging("Sheila McDonald-Rich", "ISM Navigate Tabs", "ISM FVT");
		...
		VisualReporter.logTestCaseStart("ISM Navigate Tabs");
		try {
...
//			}
			NavigateTabTask.navigateAppliance(null);
			NavigateTabTask.navigateHome(null);
			NavigateTabTask.navigateMessaging(null);
			NavigateTabTask.navigateMessageHub(null);
			NavigateTabTask.navigateMessageQueue(null);
			NavigateTabTask.navigateMessageMQConnectivity(null);
			NavigateTabTask.navigateMessageUser(null);
			NavigateTabTask.navigateMonitoring(null);
			NavigateTabTask.navigateMonitoringConnections(null);
			NavigateTabTask.navigateMonitoringEndpoints(null);
			NavigateTabTask.navigateMonitoringQueues(null);
			NavigateTabTask.navigateMonitoringTopics(null);
			NavigateTabTask.navigateMonitoringMQTTClients(null);
			NavigateTabTask.navigateMonitoringSubscriptions(null);
			NavigateTabTask.navigateMonitoringAppliance(null);
			NavigateTabTask.navigateMonitoringDownload(null);
			NavigateTabTask.navigateApplianceUsers(null);
			NavigateTabTask.navigateApplianceNetworkSettings(null);
			NavigateTabTask.navigateApplianceDateandTime(null);
			NavigateTabTask.navigateApplianceSecuritySettings(null);
			NavigateTabTask.navigateApplianceSystemControl(null);
			NavigateTabTask.navigateApplianceHighAvailability(null);
			NavigateTabTask.navigateApplianceWebUISettings(null);
