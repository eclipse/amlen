	...
	public boolean runTest(ImsLDAPTestData testData) {
		...
		if (testData.isCLITestLDAP()) {
			try {
				...
				CLICommand cmd = imaConfig.testLDAP(testData.getLDAPCommandOptions());
				if (testData.isDebug()) {
