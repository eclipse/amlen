...
/**
 * Performs Add Users tasks on the Appliance tab of the ISM Admin GUI console.
 *  
 *
 */
public class ManipulateAddUsersTasks {

	

	/**
	 * Manipulate objects on the Appliance Users page to add new user.
	 * 
	...
	public static boolean navigateAppliance(String textToVerify) {
		...
		IsmTest.delay(2000);
		ApplianceTasks.selectDropDownGroup_SysAdmins();
		IsmTest.delay(2000);
