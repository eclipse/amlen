...
import com.ibm.ism.test.tasks.FirstStepsTasks;
 ...
 *
 */
public class NavigateAllTabTasks2 {
	...
	public static boolean navigateMessaging(String textToVerify) {
		boolean success = MessagingTasks.clickMessagingTab(null);
		if (!success) {
			return success;
		}
		if (FirstStepsDialogTask.verifyFirstStepsDialog() == true) {
		...
		IsmTest.delay ();
		MessagingTasks.clickTopicAdministrationAction(null);
		IsmTest.delay ();
//		MessagingTasks.clickFooAction(null);
//		if (IsmTest.gsUserRole.equals(IsmTest.APPLIANCE_ADMIN_ROLE)) {
//			MessagingTasks.clickTopicAdministrationAction(null);
//		}
//		MessagingTasks.clickBarAction(null);
		MessagingTasks.clickListenerAction(null);
		IsmTest.delay ();
		return success;
	}
	...
	public static boolean navigateMonitoring(String textToVerify) {
		...
		IsmTest.delay ();
		MonitoringTasks.clickMonitoringTab(null);
		IsmTest.delay();
	...
	/**
	 * Navigates the First Steps page.
	 * 
	 * @param textToVerify Optional text to verify on the Monitoring page.
	 * @return true if successful
	 */
	public static boolean navigateFirstSteps(String textToVerify) {
		//boolean success = FirstStepsTasks.clickFirstStepsTab(textToVerify);
		boolean success = FirstStepsTasks.verifyPageLoaded();
		if (!success) {
			return success;
		}
		...
		IsmTest.delay ();
//		FirstStepsTasks.clickTestConnection(null);
//		FirstStepsTasks.clickSaveAndRun(null);
//		FirstStepsTasks.clickCancel(null);
//		FirstStepsTasks.clickSaveAndClose(null);
//		if (IsmTest.gsUserRole.equals(IsmTest.APPLIANCE_ADMIN_ROLE)) {
//			FirstStepsTasks.clickTestConnection(null);
//		}
//		FirstStepsTasks.clickSaveAndClose(null);
...
//		ApplianceTasks.clickProfilesAction(null);
		...
		IsmTest.delay();
		ApplianceTasks.clickLocaleAction(null);
		IsmTest.delay();
