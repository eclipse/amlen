...
public class AddMessagingPoliciesToEndpointDialogObjects {

	public static final String TITLE_ADD_MESSAGING_POLICIES_TO_ENDPOINT = "Add Messaging Policies to the Endpoint";
	
	public static SeleniumTextTestObject getTextBox_Filter() {
		return new SeleniumTextTestObject("//*[@id='ism_widgets_TextBox_4']");
	}
	
	public static SeleniumTestObject getCheckBox_FirstRow() {
		return new SeleniumTestObject("//*[@id='addMessagingPoliciesismEndpointListDialog_policiesReferencedObjectGrid']/div[3]/div[2]/div/table/tbody/tr/td[1]/div/div/div/input");
	}
