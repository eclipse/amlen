...
public class MsgAddUserDialogObject {



	public static final String TITLE_ADD_USER = "Add User";
	public static final String DIALOG_DESC = "Messaging users can be added to messaging policies to control the messaging resources that a user can access.";
	...
	public static SeleniumTestObject getTitle_AddUser() {
		return new SeleniumTestObject("//span[@id='ism_widgets_Dialog_3_title']");
	}

	public static SeleniumTextTestObject getTextEntry_UserID() {
		return new SeleniumTextTestObject("//input[@id='ism_widgets_TextBox_28']");
	}

	public static SeleniumTextTestObject getTextEntry_UserDesc() {
		return new SeleniumTextTestObject("//input[@id='ism_widgets_TextBox_29']");
	}

	public static SeleniumTextTestObject getTextEntry_UserPassword() {
		return new SeleniumTextTestObject("//input[@id='addmsgusersDialog_passwd1']");
	}

	public static SeleniumTextTestObject getTextEntry_ConfirmPassword() {
		return new SeleniumTextTestObject("//input[@id='addmsgusersDialog_passwd2']");
	}
	...
	public static SeleniumTestObject getButton_Save() {
		return new SeleniumTestObject("//span[@id='addmsgusersDialog_saveButton']");
	}
