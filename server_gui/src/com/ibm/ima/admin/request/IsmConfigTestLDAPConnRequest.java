...
public class IsmConfigTestLDAPConnRequest extends IsmConfigRequest {
    ...
    public IsmConfigTestLDAPConnRequest(String username) {
        this.Action = "Test";
    ...
    public void setFieldsFromLDAPConnection(LDAPConnection ldapConnection) {
        ...
        this.Certificate = ldapConnection.getCertificate();
    ...
    public String toString() {
        return "IsmConfigTestLDAPConnRequest [Type=" + Type + ", Item=" + Item + ", Name=" + Name + ", Delete=" + Delete + ", Update=" + Update + ", LDAPConnectionName=" + Name + "]";
    }
}
