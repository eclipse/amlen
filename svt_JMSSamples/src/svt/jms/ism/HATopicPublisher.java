 ...
 *      java com.ibm.ima.samples.jms.HATopicPublisher "server1.mycompany.com, server2.mycompany.com" 16102 haTopic 2000 "Test message" 5000 true true  120  pubClientID
 *      
...
public class HATopicPublisher {
    ...
    public static void syntaxhelp(String msg) {
        System.err.println("java HATopicPublisher serverlist serverport topicname count messagetext [msgspersec] [initdurablesub] [debug]   [connectTimeout]  [clientID} ");
        System.err.println("  Examples:");
        System.err.println("      java HATopicPublisher \"server1.mycompany.com, server2.mycompany.com\" 16102 durableTopic 2000 \"Test message\"");
        System.err.println("      java HATopicPublisher \"server1.mycompany.com, server2.mycompany.com\" 16102 durableTopic 2000 \"Test message\" 10000");
        System.err.println("      java HATopicPublisher \"server1.mycompany.com, server2.mycompany.com\" 16102 durableTopic 2000 \"Test message\" 5000 false");
        System.err.println("      java HATopicPublisher \"server1.mycompany.com, server2.mycompany.com\" 16102 durableTopic 2000 \"Test message\" 5000 true true");
        System.err.println("      java HATopicPublisher \"server1.mycompany.com, server2.mycompany.com\" 16102 durableTopic 2000 \"Test message\" 5000 true true  120  pubClientID");
        if (msg != null)
            System.err.println("\n" + msg);
        System.exit(1);
    }
    ...
    public static void parseArgs(String[] args) {
    	...
    	/* Required: SrvList, Port, topic, count, msgText */
        if (args.length < 5) {
            if (args.length == 0)
                syntaxhelp("");
            else
