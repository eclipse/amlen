...
/*
 * This utility takes a JMS client for IBM Messaging Appliance  
 ...
 * 
 * This utility also allows the contents on IBM Messaging Appliance JMS 
...
public class JMSSampleAdmin {
     ...
     */
    static void help() {
        System.out.println("java ImaJmsAdmin [options] configfile");
        System.out.println("options: ");
        System.out.println("-c url        The JNDI provider URL");
        System.out.println("-l            List IBM Messaging Appliance JMS objects in the JNDI repository");
    ...
    /*
     * List an IBM Messaging Appliance JMS object
     */
