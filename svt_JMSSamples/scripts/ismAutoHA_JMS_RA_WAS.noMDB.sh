...
#
# Description:
#   This script executes ISM test bucket for:  HA using JMS Client and ISM Resource Adapter in WAS.
#
# Input Parameters:
...
RUNCMD="../scripts/run-scenarios.sh  ism-HA_JMS_RA_WAS-01.noMDB.sh  ${logfile}"
...
# RUNCMD="../scripts/run-scenarios.sh  ism-HA_JMS_RA_WAS-02.sh ${logfile}"
# echo Running command: ${RUNCMD}
# $RUNCMD
#totalResults=$( expr ${totalResults} + $? )?
