...
# Set up the components for the test in the order they should start
component[1]=cAppDriverRC,m1,"-e|${M1_TESTROOT}/svt_jms/manualrunHAQueue","-o|5|0|487"
component[2]=cAppDriverRC,m2,"-e|${M2_TESTROOT}/svt_jms/manualrunHAQueue","-o|5|0|488"
component[3]=cAppDriverRC,m3,"-e|${M3_TESTROOT}/svt_jms/manualrunHAQueue","-o|5|0|491"
component[4]=cAppDriverRC,m4,"-e|${M4_TESTROOT}/svt_jms/manualrunHAQueue","-o|5|0|499"
