...
# Set up the components for the test in the order they should start
component[1]=cAppDriverRC,m1,"-e|${M1_TESTROOT}/svt_jms/manualrunHAQueue.noMDB","-o|5|0|487"
component[2]=cAppDriverRC,m2,"-e|${M2_TESTROOT}/svt_jms/manualrunHAQueue.noMDB","-o|5|0|488"
component[3]=cAppDriverRC,m3,"-e|${M3_TESTROOT}/svt_jms/manualrunHAQueue.noMDB","-o|5|0|491"
component[4]=cAppDriverRC,m4,"-e|${M4_TESTROOT}/svt_jms/manualrunHAQueue.noMDB","-o|5|0|499"
component[9]=cAppDriverRC,m1,"-e|${M1_TESTROOT}/svt_jms/failover.sh","-o|M1;HA_JMS_RA_WAS-execution_01-cAppDriverRC-manualrunHAQueue.noMDB-M1-1.log#M2;HA_JMS_RA_WAS-execution_01-cAppDriverRC-manualrunHAQueue.noMDB-M2-2.log#M3;HA_JMS_RA_WAS-execution_01-cAppDriverRC-manualrunHAQueue.noMDB-M3-3.log#M4;HA_JMS_RA_WAS-execution_01-cAppDriverRC-manualrunHAQueue.noMDB-M4-4.log"
