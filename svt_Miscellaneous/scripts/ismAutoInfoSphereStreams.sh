...
#
# Description:
#   This script executes ISM test bucket for:  InfoSphere Streams Test case MQTTGreenTread.SPL.
#
# Input Parameters:
...
RUNCMD="../scripts/run-scenarios.sh  ism-InfoSphereStreams-01.sh ${logfile}"
...
# RUNCMD="../scripts/run-scenarios.sh  ism-NVDIMM-02.sh ${logfile}"
# echo Running command: ${RUNCMD}
# $RUNCMD
#totalResults=$( expr ${totalResults} + $? )?
