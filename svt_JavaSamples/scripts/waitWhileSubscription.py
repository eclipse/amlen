...
#
# Usage:
#   waitWhileSubscription.py -a <address>:<port> -i <clientid> -f <field> -c <comparison> -v <value> -w <wait> -m <maxwait>'
#
# Example command:
...
def usage(err):
   print(err)
   print __file__ + ' -a <address>:<port> -i <clientid> -f <field> -c <comparison> -v <value> -w <wait> -m <maxwait>'
   print ''
   sys.exit(2)
...
def main(argv):
   ...
   try:
      options, optargs = getopt.getopt(argv,"a:i:c:v:w:m:f:h",["endpoint1=","clientid=","comparison=","value=","field=","wait=","maxwait="])
