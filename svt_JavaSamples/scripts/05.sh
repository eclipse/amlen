...
scenario_set_name="JMQTT Scenarios 05"
source ../scripts/commonFunctions.sh

test_template_set_prefix "jmqtt_05_"
...
#----------------------------
printf -v tname "jmqtt_05_%02d" ${n}
...
declare -li sharedsubport=16215
declare -li gatherpubport=16218
declare -li gathersubport=16217
declare subserver=tcp://${A1_IPv4_1}:${sharedsubport}+tcp://${A2_IPv4_1}:${sharedsubport}
...
# test_template5_JMSClientWait -a subscribe -t "/svtGroup0/chat" -s ${subserver} -v -b -u u0000014 -p imasvtest -n 0 -resendURI ${gatherpubserver} -resendID u0000024 -debug -resendTopic /svtGroup0/chat/gather -shared dog 

test_template5_MQTTClient -a subscribe -mqtt 3.1.1 -t /svtGroup0/chat/gather -s ${gathersubserver} -i u0000010 -v -q 2 -c false -u u0000010 -p imasvtest -n 4000 -gather -O -sharedsubscribers 2  -debug 
test_template5_SearchString "Order check SUCCESS"

test_template5_MQTTClient -vv -debug -a subscribe -mqtt 3.1.1 -q 2 -t '\$SharedSubscription/dog//svtGroup0/chat' -s ${subserver} -i u0000011 -u u0000011 -p imasvtest -v -c false  -Nm 2 -resendURI ${gatherpubserver} -resendID u0000021 -resendTopic /svtGroup0/chat/gather 
test_template5_MQTTClient -vv -debug -a subscribe -mqtt 3.1.1 -q 2 -t '\$SharedSubscription/dog//svtGroup0/chat' -s ${subserver} -i u0000014 -u u0000014 -p imasvtest -v -c false  -Nm 2 -resendURI ${gatherpubserver} -resendID u0000024 -resendTopic /svtGroup0/chat/gather 
# test_template5_JMSClient -a subscribe -t "/svtGroup0/chat" -s ${subserver} -v -b -u u0000014 -p imasvtest -Nm 2 -resendURI ${gatherpubserver} -resendID u0000024 -debug -resendTopic /svtGroup0/chat/gather -shared dog 
