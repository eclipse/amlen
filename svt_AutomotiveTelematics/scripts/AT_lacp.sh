...
test_template_set_prefix "atelm_AT_lacp_"
...
# setup lacp
#----------------------------
printf -v tname "atelm_AT_lacp_%00d" ${n}

xml[${n}]=${tname}
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - setup lacp"
timeouts[${n}]=60
...
#----------------------------
printf -v tname "atelm_AT_lacp_%02d" ${n}
...
xml[$n]="atelm_AT_lacp_0$n"
test_template_initialize_test "atelm_AT_lacp_0$n"
scenario[$n]="atelm_AT_lacp_0$n "
...
xml[${n}]=${tname}
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - unconfig lacp"
timeouts[${n}]=60
