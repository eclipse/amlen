...
scenario_set_name="Automotive Telematics Scenarios 07"
...
# atelm_07_00
printf -v xml[${n}] "atelm_07_%02d" ${n}
...
test_template_compare_string[3]="serverControl.sh exited successfully"
component[4]=cAppDriverWait,m1,"-e|../scripts/serverControl.sh","-o|-a|startServer|-i|2"
test_template_compare_string[4]="serverControl.sh exited successfully"
