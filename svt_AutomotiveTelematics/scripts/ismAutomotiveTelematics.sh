...
# REMOVED UNTIL FIXED  -- see task 27138 ---
# if [[ (${ISM_BUILDTYPE} == "development") || (${ISM_BUILDTYPE} == "manual") ]]
#  then 
...
run04Result=0
# REMOVED UNTIL FIXED  -- see task 27141 ---
#if [[ (${ISM_BUILDTYPE} == "development") || (${ISM_BUILDTYPE} == "production") || (${ISM_BUILDTYPE} == "manual") ]]
#then 
...
# REMOVED UNTIL FIXED  -- see task 27144 ---
#
run05Result=0
