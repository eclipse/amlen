...
public class ImaMessageNotWriteableRuntimeException extends MessageNotWriteableRuntimeException implements ImaJmsException {
    private static final long serialVersionUID = 7796778770758220727L;
    ...
    /*
     * Create a MessageNotWriteableException with reason string.
     * @param errorcode  The error code for the exception
     * @param reason     The reason as a string
     */
    public ImaMessageNotWriteableRuntimeException(String errorcode, String reason) {
        super(reason, errorcode);
        msgfmt = reason;
    }
    /*
     * Create a MessageNotWriteableException with a reason message.
     * @param errorcode  The error code for the exception
     * @param reasonmsg  The reason as a Java message format
     * @param repl       An array of replacement data
     */
    public ImaMessageNotWriteableRuntimeException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaMessageNotWriteableRuntimeException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsRuntimeException.formatException(reasonmsg, repl), errorcode);
        msgfmt = reasonmsg;
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "MessageNotWritableRuntimeException: " + getErrorCode() + " " + getMessage();
    }
}
