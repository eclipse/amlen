...
public class ImaInvalidDestinationRuntimeException extends InvalidDestinationRuntimeException implements ImaJmsException {
     ...
     */
    public ImaInvalidDestinationRuntimeException(String errorcode, String reason) {
     ...
     */
    public ImaInvalidDestinationRuntimeException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaInvalidDestinationRuntimeException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsRuntimeException.formatException(reasonmsg, repl), errorcode);
        msgfmt = reasonmsg;
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "InvalidDestinationRuntimeException: " + getErrorCode() + " " + getMessage();
    }
}
