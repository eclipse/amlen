...
public class ImaIllegalStateRuntimeException extends IllegalStateRuntimeException implements ImaJmsException {
     ...
     */
    public ImaIllegalStateRuntimeException(String errorcode, String reason ) {
     ...
     */
    public ImaIllegalStateRuntimeException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaIllegalStateRuntimeException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsRuntimeException.formatException(reasonmsg, repl), errorcode);
        msgfmt = reasonmsg;
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "IllegalStateRuntimeException: " + getErrorCode() + " " + getMessage();
    }
}
