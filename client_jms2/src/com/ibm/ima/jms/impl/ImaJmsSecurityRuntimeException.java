...
public class ImaJmsSecurityRuntimeException extends JMSSecurityRuntimeException implements
		ImaJmsException {
     ...
     */
    public ImaJmsSecurityRuntimeException(String errorcode, String reason) {
     ...
     */
    public ImaJmsSecurityRuntimeException(String errorcode, String reasonmsg, Object ... repl ) {
     ...
     * @param repl       An array of replacement data
     */
    public ImaJmsSecurityRuntimeException(String errorcode, Throwable cause, String reasonmsg, Object ... repl ) {
        super(ImaJmsRuntimeException.formatException(reasonmsg, repl), errorcode);
        msgfmt = reasonmsg;
        this.repl = repl;
        if (cause != null) {
    ...
    public String toString() {
        return "JMSSecurityRuntimeException: " + getErrorCode() + " " + getMessage();
    }
}
