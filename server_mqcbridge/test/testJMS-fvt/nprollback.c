...
/*
gcc -g -o nprollback nprollback.c -lismc -lssl -lismengine -lismmonitoring -I $BROOT/server_ship/include -I $SROOT/server_ismc/src -I $SROOT/server_protocol/src -L $BROOT/server_ship/lib  -Wl,-rpath $BROOT/server_ship/lib
*/
...
int publish(ismc_connection_t * pConn)
{
    ...
    {
        ismc_setDeliveryMode(pMessage,
            (i == 1) ? ISMC_NON_PERSISTENT : ISMC_PERSISTENT);
...
int main(int argc, char **argv)
{
    ...
    printf("ismc_endGlobalTransaction rc(%d)", rc);
