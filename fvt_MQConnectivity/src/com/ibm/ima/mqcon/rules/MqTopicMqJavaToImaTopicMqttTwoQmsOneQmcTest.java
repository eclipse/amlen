...
public class MqTopicMqJavaToImaTopicMqttTwoQmsOneQmcTest extends
MqTopicToImaDestination {

	public MqTopicMqJavaToImaTopicMqttTwoQmsOneQmcTest() {
		super();
	...
	public static void main(String[] args) {
		...
		for (int x : mqPersistences) {
			for (int qos=0; qos <=2; qos++) {
				MqTopicMqJavaToImaTopicMqttTwoQmsOneQmcTest test = null;
				try {
					test = new MqTopicMqJavaToImaTopicMqttTwoQmsOneQmcTest();
					test.setNumberOfMessages(1000);
					test.setNumberOfPublishers(1);
					test.setNumberOfSubscribers(1);
					test.topicString = "MQTopic/To/ISMTopic/FanIn2QM1QMC";
