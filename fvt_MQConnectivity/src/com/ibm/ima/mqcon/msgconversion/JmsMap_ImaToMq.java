...
/**
 * Test sends a JMS Map message to IMA topic
...
public class JmsMap_ImaToMq extends JmsToJms {
	...
	public void sendJMSMapMessage()
	{
		try
		{
			...
			Message msg = JmsMessage.createMessageBody(producerSession, JmsMessage.MESSAGE_TYPE.MAP);
