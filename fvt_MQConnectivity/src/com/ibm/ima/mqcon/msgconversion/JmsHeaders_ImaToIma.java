...
*
*/
public class JmsHeaders_ImaToIma extends JmsToJms{


	public static void main(String[] args) {
		
		new Trace().traceAutomation();
		JmsHeaders_ImaToIma testClass = new JmsHeaders_ImaToIma();
		testClass.setNumberOfMessages(1);
		testClass.setNumberOfPublishers(1);
		testClass.setNumberOfSubscribers(1);
		testClass.setTestName("JmsHeaders_ImaToIma");
	...
	public void sendJMSTextHeaderMessage()
	{
		try
		{
			...
			{
				if(CompareMessageContents.checkJMSMessageEquality(msg, imaMessage, JmsMessage.imaTopic + imadestinationName, null))
				{
					if(Trace.traceOn())
					{
