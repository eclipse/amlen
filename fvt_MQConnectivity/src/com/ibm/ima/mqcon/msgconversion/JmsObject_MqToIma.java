...
/**
 * Test sends a JMS Object message to an MQ topic
 ...
 *
 */
public class JmsObject_MqToIma extends JmsToJms{

	
	public static void main(String[] args) {
		
		new Trace().traceAutomation();
		JmsObject_MqToIma testClass = new JmsObject_MqToIma();
		testClass.setNumberOfMessages(1);
		testClass.setNumberOfPublishers(1);
		testClass.setNumberOfSubscribers(1);
		testClass.setTestName("JmsObject_MqToIma");
