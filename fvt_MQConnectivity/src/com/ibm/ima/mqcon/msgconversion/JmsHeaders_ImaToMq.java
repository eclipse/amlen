...
/**
 * Test sends a JMS Text message with headers to IMA topic
 ...
 *
 */
public class JmsHeaders_ImaToMq extends JmsToJms {
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			testClass.sendJMSTextHeaderMessage();
	...
	public void sendJMSTextHeaderMessage()
	{
		try
		{
			if(Trace.traceOn())
			...
			Message msg = JmsMessage.createMessageJMSProps(producerSession, JmsMessage.MESSAGE_TYPE.TEXT);
			...
			{
				if(CompareMessageContents.checkJMSMessageEquality(msg, mqMessage, JmsMessage.mqTopic+mqDestinationName, JmsMessage.mqTopic))
				{
					if(Trace.traceOn())
					{
