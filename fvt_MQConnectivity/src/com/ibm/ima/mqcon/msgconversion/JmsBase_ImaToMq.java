...
/**
 * Test sends a JMS Base message to IMA topic
 ...
 *
 */
public class JmsBase_ImaToMq extends JmsToJms {
	...
	public void sendJMSBaseMessage()
	{
		try
		{
			if(Trace.traceOn())
			...
			Message msg = JmsMessage.createMessage(producerSession, JmsMessage.MESSAGE_TYPE.BASE);
