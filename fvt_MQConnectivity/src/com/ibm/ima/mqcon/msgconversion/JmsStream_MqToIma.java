...
/**
 * Test sends a JMS Stresm message to an MQ topic
 ...
 *
 */
public class JmsStream_MqToIma extends JmsToJms{


	public static void main(String[] args) {
		
		new Trace().traceAutomation();
		JmsStream_MqToIma testClass = new JmsStream_MqToIma();
		testClass.setNumberOfMessages(1);
		testClass.setNumberOfPublishers(1);
		testClass.setNumberOfSubscribers(1);
		testClass.setTestName("JmsStream_MqToIma");
