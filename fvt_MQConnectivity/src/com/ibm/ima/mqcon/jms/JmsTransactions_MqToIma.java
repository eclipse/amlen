...
/*** Test sends JMS Text messages to MQ topic
* and is received from an IMA topic when commit is called
...
*
*/
public class JmsTransactions_MqToIma extends JmsToJms{

	
	public static void main(String[] args) {
		
		new Trace().traceAutomation();
		JmsTransactions_MqToIma testClass = new JmsTransactions_MqToIma();
		testClass.setNumberOfMessages(3);
		testClass.setNumberOfPublishers(1);
		testClass.setNumberOfSubscribers(1);
		testClass.setTestName("JmsTransactions_MqToIma");
	...
	public void testTransactions()
	{
		try
		{
			...
			if(Trace.traceOn())
			{
				Trace.trace("Sending three messages to MQ");
			}
