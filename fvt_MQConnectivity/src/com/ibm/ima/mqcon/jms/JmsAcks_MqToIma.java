...
public class JmsAcks_MqToIma extends JmsToJms{
	...
	public void testMessageAck()
	{
		try
		{
			if(Trace.traceOn())
			{
				Trace.trace("Creating the default producer session for MQ and consumer session for IMA with CLIENT_ACKNOWLEDGEMENT");
			}
