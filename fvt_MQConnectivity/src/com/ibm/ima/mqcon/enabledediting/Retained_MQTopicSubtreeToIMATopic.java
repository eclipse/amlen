...
/**
 * Test 6 - MQ Topic Subtree to IMA Topic
 * 
...
public class Retained_MQTopicSubtreeToIMATopic extends JmsToJms {
	
	static EnabledEditConfig config;
	static String testName = "Retained_MQTopicSubtreeToIMATopic";
	...
	public static void main(String[] args) {
		...
		Retained_MQTopicSubtreeToIMATopic testClass = new Retained_MQTopicSubtreeToIMATopic();
	 ...
	 * Constructors
	 */
	public Retained_MQTopicSubtreeToIMATopic(){
		//TODO - Fill this in (with what?)
	}
	
	public Retained_MQTopicSubtreeToIMATopic(EnabledEditConfig configObject){
		config = configObject;
	}
	...
	public void startTest(){
		try {
			...
			if(!config.mqConn.mappingRuleExists(testName)){
				...
				config.mqConn.createMappingRule(testName, config.prefixName, "8", mqDestinationName, imadestinationName);
				if(config.mqConn.mappingRuleExists(testName)){
