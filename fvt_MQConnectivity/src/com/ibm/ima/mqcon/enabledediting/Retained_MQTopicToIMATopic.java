...
public class Retained_MQTopicToIMATopic extends JmsToJms {
	
	static EnabledEditConfig config;
	static String testName = "Retained_MQTopicToIMATopic";
	...
	public static void main(String[] args) {
		...
		Retained_MQTopicToIMATopic testClass = new Retained_MQTopicToIMATopic();
	 ...
	 * Constructors
	 */
	public Retained_MQTopicToIMATopic(){
		//TODO - Fill this in (with what?)
	}
	
	public Retained_MQTopicToIMATopic(EnabledEditConfig configObject){
		config = configObject;
	}
	...
	public void startTest(){
		try {
			...
			if(!config.mqConn.mappingRuleExists(testName)){
				...
				config.mqConn.createMappingRule(testName, config.prefixName, "4", mqDestinationName, imadestinationName);
				if(config.mqConn.mappingRuleExists(testName)){
