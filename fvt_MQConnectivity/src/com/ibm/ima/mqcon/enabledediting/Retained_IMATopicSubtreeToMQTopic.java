...
/**
 * Test 4 - IMA Topic Subtree to MQ Topic
 * 
...
public class Retained_IMATopicSubtreeToMQTopic extends JmsToJms{
	
	static EnabledEditConfig config;
	static String testName = "Retained_IMATopicSubtreeToMQTopic";
	
	public static void main(String[] args) {
		
		new Trace().traceAutomation();
		Retained_IMATopicSubtreeToMQTopic testClass = new Retained_IMATopicSubtreeToMQTopic();
	 ...
	 * Constructers
	 */
	public Retained_IMATopicSubtreeToMQTopic(){
		//TODO - Fill this in (with what?)
		new Trace().traceAutomation();
	}
	
	public Retained_IMATopicSubtreeToMQTopic(EnabledEditConfig configObject){
		new Trace().traceAutomation();
		config = configObject;
	...
	public void startTest(){
		try {
			...
			if(!config.mqConn.mappingRuleExists(testName)){
				...
				config.mqConn.createMappingRule(testName, config.prefixName, "6", imadestinationName, mqDestinationName);
				if(config.mqConn.mappingRuleExists(testName)){
