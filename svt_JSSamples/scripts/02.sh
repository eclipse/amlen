...
scenario_set_name="Java Script MQTT Sample Application - Basic test in 3.1.1 mode"
...
scenario[${n}]="${xml[${n}]} - JavaScript MQTT 2 Pub, 2Sub, 400 msgs, QoS 2 - Basic test 311 mode"
# Set up the components for the test in the order they should start
...
component[1]=cAppDriver,m1,"-e|firefox","-o|http://${M1_HOST}${M1_TESTROOT}/svt_jsws/web/svtStockTickerScale.html?logfile=${test_template_search_file[1]}&clientID=M1&mqttVersion=4&winClose=true","-s-DISPLAY=localhost:1"
...
test_template_compare_string[1]+=$'\nSub Client SUBM1_0 Completed!  Expected Msgs: 800  Received Msgs: 800'
test_template_compare_string[1]+=$'\nSub Client SUBM1_1 Completed!  Expected Msgs: 800  Received Msgs: 800'
test_template_compare_string[1]+=$'\nTest Successful!'
...
xml[${n}]="jsws_02_02"
test_template_initialize_test "${xml[${n}]}"
scenario[${n}]="${xml[${n}]} - 3 StockTicker @ JavaScript MQTT 6 Pub, 6Sub, 400 msgs, QoS 2 - Basic test 311 mode"
timeouts[${n}]=200
#
test_template_search_file[1]=${xml[${n}]}-cAppDriver-firefox-M1-1js.screenout
...
component[1]=cAppDriver,m1,"-e|firefox","-o|http://${M1_HOST}${M1_TESTROOT}/svt_jsws/web/svtStockTickerScale.html?logfile=${test_template_search_file[1]}&clientID=M1&mqttVersion=4&winClose=true","-s-DISPLAY=localhost:1"
component[2]=cAppDriver,m2,"-e|firefox","-o|http://${M1_HOST}${M1_TESTROOT}/svt_jsws/web/svtStockTickerScale.html?logfile=${test_template_search_file[2]}&clientID=M2&mqttVersion=4&winClose=true","-s-DISPLAY=localhost:1"
component[3]=cAppDriver,m3,"-e|firefox","-o|http://${M1_HOST}${M1_TESTROOT}/svt_jsws/web/svtStockTickerScale.html?logfile=${test_template_search_file[3]}&clientID=M3&mqttVersion=4&winClose=true","-s-DISPLAY=localhost:1"
...
test_template_compare_string[2]+=$'\nSub Client SUBM2_0 Completed!  Expected Msgs: 800  Received Msgs: 800'
test_template_compare_string[2]+=$'\nSub Client SUBM2_1 Completed!  Expected Msgs: 800  Received Msgs: 800'  
test_template_compare_string[2]+=$'\nTest Successful!'
...
test_template_compare_string[3]+=$'\nSub Client SUBM3_0 Completed!  Expected Msgs: 800  Received Msgs: 800'
test_template_compare_string[3]+=$'\nSub Client SUBM3_1 Completed!  Expected Msgs: 800  Received Msgs: 800'  
test_template_compare_string[3]+=$'\nTest Successful!'
